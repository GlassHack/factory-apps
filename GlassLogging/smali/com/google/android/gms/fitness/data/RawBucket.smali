...
.field final Ct:Lcom/google/android/gms/fitness/data/Session;
...
.method constructor <init>(IJJLcom/google/android/gms/fitness/data/Session;ILjava/util/List;IZ)V
    ...
    iput-wide p2, p0, Lcom/google/android/gms/fitness/data/RawBucket;->zf:J

    iput-wide p4, p0, Lcom/google/android/gms/fitness/data/RawBucket;->Cr:J

    iput-object p6, p0, Lcom/google/android/gms/fitness/data/RawBucket;->Ct:Lcom/google/android/gms/fitness/data/Session;

    iput p7, p0, Lcom/google/android/gms/fitness/data/RawBucket;->CB:I

    iput-object p8, p0, Lcom/google/android/gms/fitness/data/RawBucket;->CC:Ljava/util/List;

    iput p9, p0, Lcom/google/android/gms/fitness/data/RawBucket;->CD:I

    iput-boolean p10, p0, Lcom/google/android/gms/fitness/data/RawBucket;->CE:Z
...
.method public constructor <init>(Lcom/google/android/gms/fitness/data/Bucket;Ljava/util/List;Ljava/util/List;)V
    ...
    iput-wide v0, p0, Lcom/google/android/gms/fitness/data/RawBucket;->zf:J

    invoke-virtual {p1}, Lcom/google/android/gms/fitness/data/Bucket;->getEndTimeMillis()J

    move-result-wide v0

    iput-wide v0, p0, Lcom/google/android/gms/fitness/data/RawBucket;->Cr:J
    ...
    iput-object v0, p0, Lcom/google/android/gms/fitness/data/RawBucket;->Ct:Lcom/google/android/gms/fitness/data/Session;

    invoke-virtual {p1}, Lcom/google/android/gms/fitness/data/Bucket;->getActivity()I

    move-result v0

    iput v0, p0, Lcom/google/android/gms/fitness/data/RawBucket;->CB:I

    invoke-virtual {p1}, Lcom/google/android/gms/fitness/data/Bucket;->getBucketType()I

    move-result v0

    iput v0, p0, Lcom/google/android/gms/fitness/data/RawBucket;->CD:I

    invoke-virtual {p1}, Lcom/google/android/gms/fitness/data/Bucket;->serverHasMoreData()Z

    move-result v0

    iput-boolean v0, p0, Lcom/google/android/gms/fitness/data/RawBucket;->CE:Z
    ...
    iput-object v1, p0, Lcom/google/android/gms/fitness/data/RawBucket;->CC:Ljava/util/List;
    ...
    iget-object v2, p0, Lcom/google/android/gms/fitness/data/RawBucket;->CC:Ljava/util/List;
...
.method private a(Lcom/google/android/gms/fitness/data/RawBucket;)Z
    ...
    iget-wide v0, p0, Lcom/google/android/gms/fitness/data/RawBucket;->zf:J
    ...
    iget-wide v0, p0, Lcom/google/android/gms/fitness/data/RawBucket;->Cr:J

    iget-wide v2, p1, Lcom/google/android/gms/fitness/data/RawBucket;->Cr:J

    cmp-long v0, v0, v2

    if-nez v0, :cond_0

    iget v0, p0, Lcom/google/android/gms/fitness/data/RawBucket;->CB:I

    iget v1, p1, Lcom/google/android/gms/fitness/data/RawBucket;->CB:I

    if-ne v0, v1, :cond_0

    iget-object v0, p0, Lcom/google/android/gms/fitness/data/RawBucket;->CC:Ljava/util/List;

    iget-object v1, p1, Lcom/google/android/gms/fitness/data/RawBucket;->CC:Ljava/util/List;
    ...
    iget v0, p0, Lcom/google/android/gms/fitness/data/RawBucket;->CD:I

    iget v1, p1, Lcom/google/android/gms/fitness/data/RawBucket;->CD:I

    if-ne v0, v1, :cond_0

    iget-boolean v0, p0, Lcom/google/android/gms/fitness/data/RawBucket;->CE:Z

    iget-boolean v1, p1, Lcom/google/android/gms/fitness/data/RawBucket;->CE:Z
...
.method public hashCode()I
    ...
    iget-wide v2, p0, Lcom/google/android/gms/fitness/data/RawBucket;->zf:J
    ...
    iget-wide v2, p0, Lcom/google/android/gms/fitness/data/RawBucket;->Cr:J
    ...
    iget v2, p0, Lcom/google/android/gms/fitness/data/RawBucket;->CD:I
...
.method public toString()Ljava/lang/String;
    ...
    iget v2, p0, Lcom/google/android/gms/fitness/data/RawBucket;->CB:I
    ...
    iget-boolean v2, p0, Lcom/google/android/gms/fitness/data/RawBucket;->CE:Z
