...
.method public updateRecord(Ljavax/jmdns/impl/DNSCache;JLjavax/jmdns/impl/DNSEntry;)V
    ...
    instance-of v12, v0, Ljavax/jmdns/impl/DNSRecord;
    ...
    .line 868
    .local v9, "serviceUpdated":Z
    sget-object v12, Ljavax/jmdns/impl/ServiceInfoImpl$1;->$SwitchMap$javax$jmdns$impl$constants$DNSRecordType:[I
    ...
    .line 922
    .local v3, "dns":Ljavax/jmdns/impl/JmDNSImpl;
    if-eqz v3, :cond_1
    ...
    invoke-virtual {v0, v3}, Ljavax/jmdns/impl/DNSRecord;->getServiceEvent(Ljavax/jmdns/impl/JmDNSImpl;)Ljavax/jmdns/ServiceEvent;
    ...
    invoke-direct {v6, v3, v12, v13, p0}, Ljavax/jmdns/impl/ServiceEventImpl;-><init>(Ljavax/jmdns/impl/JmDNSImpl;Ljava/lang/String;Ljava/lang/String;Ljavax/jmdns/ServiceInfo;)V

    .line 925
    .end local v5    # "event":Ljavax/jmdns/ServiceEvent;
    .local v6, "event":Ljavax/jmdns/ServiceEvent;
    invoke-virtual {v3, v6}, Ljavax/jmdns/impl/JmDNSImpl;->handleServiceResolved(Ljavax/jmdns/ServiceEvent;)V

    .line 929
    .end local v3    # "dns":Ljavax/jmdns/impl/JmDNSImpl;
    ...
    .line 933
    .end local v9    # "serviceUpdated":Z
    :cond_2
    return-void

    .line 870
    .restart local v9    # "serviceUpdated":Z
    ...
    .line 871
    iget-object v13, p0, Ljavax/jmdns/impl/ServiceInfoImpl;->_ipv4Addresses:Ljava/util/Set;

    move-object/from16 v12, p4

    check-cast v12, Ljavax/jmdns/impl/DNSRecord$Address;

    invoke-virtual {v12}, Ljavax/jmdns/impl/DNSRecord$Address;->getAddress()Ljava/net/InetAddress;
    ...
    .line 877
    iget-object v13, p0, Ljavax/jmdns/impl/ServiceInfoImpl;->_ipv6Addresses:Ljava/util/Set;
    ...
    .line 883
    check-cast v10, Ljavax/jmdns/impl/DNSRecord$Service;

    .line 884
    .local v10, "srv":Ljavax/jmdns/impl/DNSRecord$Service;
    iget-object v12, p0, Ljavax/jmdns/impl/ServiceInfoImpl;->_server:Ljava/lang/String;

    if-eqz v12, :cond_3

    iget-object v12, p0, Ljavax/jmdns/impl/ServiceInfoImpl;->_server:Ljava/lang/String;

    invoke-virtual {v10}, Ljavax/jmdns/impl/DNSRecord$Service;->getServer()Ljava/lang/String;
    ...
    .line 885
    .local v8, "serverChanged":Z
    :goto_1
    invoke-virtual {v10}, Ljavax/jmdns/impl/DNSRecord$Service;->getServer()Ljava/lang/String;

    move-result-object v12

    iput-object v12, p0, Ljavax/jmdns/impl/ServiceInfoImpl;->_server:Ljava/lang/String;

    .line 886
    invoke-virtual {v10}, Ljavax/jmdns/impl/DNSRecord$Service;->getPort()I

    move-result v12

    iput v12, p0, Ljavax/jmdns/impl/ServiceInfoImpl;->_port:I

    .line 887
    invoke-virtual {v10}, Ljavax/jmdns/impl/DNSRecord$Service;->getWeight()I

    move-result v12

    iput v12, p0, Ljavax/jmdns/impl/ServiceInfoImpl;->_weight:I

    .line 888
    invoke-virtual {v10}, Ljavax/jmdns/impl/DNSRecord$Service;->getPriority()I

    move-result v12

    iput v12, p0, Ljavax/jmdns/impl/ServiceInfoImpl;->_priority:I

    .line 889
    if-eqz v8, :cond_6

    .line 890
    iget-object v12, p0, Ljavax/jmdns/impl/ServiceInfoImpl;->_ipv4Addresses:Ljava/util/Set;

    invoke-interface {v12}, Ljava/util/Set;->clear()V

    .line 891
    iget-object v12, p0, Ljavax/jmdns/impl/ServiceInfoImpl;->_ipv6Addresses:Ljava/util/Set;
    ...
    sget-object v13, Ljavax/jmdns/impl/constants/DNSRecordType;->TYPE_A:Ljavax/jmdns/impl/constants/DNSRecordType;

    sget-object v14, Ljavax/jmdns/impl/constants/DNSRecordClass;->CLASS_IN:Ljavax/jmdns/impl/constants/DNSRecordClass;

    move-object/from16 v0, p1

    invoke-virtual {v0, v12, v13, v14}, Ljavax/jmdns/impl/DNSCache;->getDNSEntryList(Ljava/lang/String;Ljavax/jmdns/impl/constants/DNSRecordType;Ljavax/jmdns/impl/constants/DNSRecordClass;)Ljava/util/Collection;
    ...
    invoke-virtual {p0, v0, v1, v2, v4}, Ljavax/jmdns/impl/ServiceInfoImpl;->updateRecord(Ljavax/jmdns/impl/DNSCache;JLjavax/jmdns/impl/DNSEntry;)V
    ...
    .restart local v8    # "serverChanged":Z
    :cond_5
    iget-object v12, p0, Ljavax/jmdns/impl/ServiceInfoImpl;->_server:Ljava/lang/String;

    sget-object v13, Ljavax/jmdns/impl/constants/DNSRecordType;->TYPE_AAAA:Ljavax/jmdns/impl/constants/DNSRecordType;
    ...
    .line 905
    .end local v8    # "serverChanged":Z
    .end local v10    # "srv":Ljavax/jmdns/impl/DNSRecord$Service;
    :pswitch_3
    invoke-virtual/range {p4 .. p4}, Ljavax/jmdns/impl/DNSEntry;->getName()Ljava/lang/String;
    ...
    .line 906
    check-cast v11, Ljavax/jmdns/impl/DNSRecord$Text;

    .line 907
    .local v11, "txt":Ljavax/jmdns/impl/DNSRecord$Text;
    invoke-virtual {v11}, Ljavax/jmdns/impl/DNSRecord$Text;->getText()[B

    move-result-object v12

    iput-object v12, p0, Ljavax/jmdns/impl/ServiceInfoImpl;->_text:[B
    ...
    .line 912
    .end local v11    # "txt":Ljavax/jmdns/impl/DNSRecord$Text;
    :pswitch_4
    invoke-virtual {p0}, Ljavax/jmdns/impl/ServiceInfoImpl;->getSubtype()Ljava/lang/String;
    ...
    iput-object v12, p0, Ljavax/jmdns/impl/ServiceInfoImpl;->_subtype:Ljava/lang/String;
