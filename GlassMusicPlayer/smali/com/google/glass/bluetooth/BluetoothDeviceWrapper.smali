...
.method public hasNap()Z
    ...
    .line 153
    sget-object v2, Lcom/google/glass/bluetooth/BluetoothDeviceWrapper;->logger:Lcom/google/glass/logging/FormattingLogger;

    const-string v3, "Don\'t have SDP records for %s"
    ...
    invoke-virtual {v6, v5}, Landroid/os/ParcelUuid;->equals(Ljava/lang/Object;)Z
...
.method public isGlass()Z
    ...
    sget-object v4, Lcom/google/glass/bluetooth/BluetoothUuids;->IDENTITY_UUID:Landroid/os/ParcelUuid;
    ...
    and-int/lit16 v2, v2, 0x714

    const/16 v4, 0x714

    if-ne v2, v4, :cond_3

    const-string v2, "00:1A:11"
