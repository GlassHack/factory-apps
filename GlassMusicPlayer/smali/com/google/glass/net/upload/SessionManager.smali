...
.method establishNewSession()V
    ...
    iput-object v0, p0, Lcom/google/glass/net/upload/SessionManager;->sessionUri:Ljava/net/URI;

    .line 315
    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lcom/google/glass/net/upload/SessionManager;->lastOffset:J

    .line 317
    iget-object v0, p0, Lcom/google/glass/net/upload/SessionManager;->logger:Lcom/google/glass/logging/FormattingLogger;

    const-string v1, "[%s] Establishing new session."
    ...
    .line 318
    sget-object v0, Lcom/google/glass/net/upload/ScottyHelper$UploadCommand;->START:Lcom/google/glass/net/upload/ScottyHelper$UploadCommand;

    invoke-virtual {p0, v0}, Lcom/google/glass/net/upload/SessionManager;->makeRequest(Lcom/google/glass/net/upload/ScottyHelper$UploadCommand;)Lcom/google/glass/net/SimplifiedHttpResponse;
    ...
    .line 326
    :cond_1
    iget-object v0, v0, Lcom/google/glass/net/SimplifiedHttpResponse;->headers:Ljava/util/Map;
    ...
    const-string v1, "[%s] Session established at URL %s"
    ...
    .line 328
    sget-object v0, Lcom/google/glass/userevent/UserEventAction;->SESSION_MANAGER_SESSION_ESTABLISHED:Lcom/google/glass/userevent/UserEventAction;

    invoke-direct {p0, v0}, Lcom/google/glass/net/upload/SessionManager;->logEvent(Lcom/google/glass/userevent/UserEventAction;)V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/google/glass/net/upload/SessionTracker;->setSessionUri(Ljava/lang/String;Ljava/net/URI;)Z
...
.method public init()V
    ...
    invoke-virtual {v0, v1}, Lcom/google/glass/net/upload/SessionTracker;->getSessionUri(Ljava/lang/String;)Ljava/net/URI;
    ...
    const-string v1, "[%s] Session not previously established -- will establish a new session."
    ...
    .line 177
    sget-object v0, Lcom/google/glass/userevent/UserEventAction;->SESSION_MANAGER_SESSION_NEW:Lcom/google/glass/userevent/UserEventAction;
    ...
    .line 181
    :cond_0
    sget-object v0, Lcom/google/glass/net/upload/ScottyHelper$UploadCommand;->QUERY:Lcom/google/glass/net/upload/ScottyHelper$UploadCommand;
    ...
    const-string v1, "[%s] Scotty has no knowledge of session at URI %s or session has been prematurely finalized -- will establish a new session."
    ...
    .line 187
    sget-object v0, Lcom/google/glass/userevent/UserEventAction;->SESSION_MANAGER_SESSION_INVALID:Lcom/google/glass/userevent/UserEventAction;
    ...
    .line 198
    sget-object v1, Lcom/google/glass/userevent/UserEventAction;->SESSION_MANAGER_SESSION_FINISHED:Lcom/google/glass/userevent/UserEventAction;
    ...
    const-string v2, "[%s] Previous session is in status %s and no body was received -- will establish  a new session."
    ...
    .line 213
    sget-object v1, Lcom/google/glass/userevent/UserEventAction;->SESSION_MANAGER_SESSION_BROKEN:Lcom/google/glass/userevent/UserEventAction;
    ...
    const-string v3, "Session is ACTIVE, but no bytes received header found: "
    ...
    const-string v2, "[%s] Previous session verified -- will re-use existing session."
    ...
    .line 220
    sget-object v1, Lcom/google/glass/userevent/UserEventAction;->SESSION_MANAGER_SESSION_VALID:Lcom/google/glass/userevent/UserEventAction;
...
.method makeRequest(Lcom/google/glass/net/upload/ScottyHelper$UploadCommand;)Lcom/google/glass/net/SimplifiedHttpResponse;
    ...
    .line 241
    iget-object v0, p0, Lcom/google/glass/net/upload/SessionManager;->baseUploadUri:Ljava/net/URI;
    ...
    .line 245
    const-string v0, "Session URI is null for a QUERY command -- did you call SessionManager#init?"
    ...
    iget-wide v4, p0, Lcom/google/glass/net/upload/SessionManager;->lastModifiedMillis:J

    invoke-static {v1, p1, v3, v4, v5}, Lcom/google/glass/net/upload/ScottyHelper;->makeBaseHeaders(Lcom/google/glass/auth/AuthUtils;Lcom/google/glass/net/upload/ScottyHelper$UploadCommand;Ljava/lang/String;J)Ljava/util/Map;
    ...
    .line 258
    iget-object v1, p0, Lcom/google/glass/net/upload/SessionManager;->dispatcher:Lcom/google/glass/net/HttpRequestDispatcher;

    invoke-virtual {v0}, Ljava/net/URI;->toString()Ljava/lang/String;

    move-result-object v3

    invoke-interface {v1, v3, v2, v8}, Lcom/google/glass/net/HttpRequestDispatcher;->postWithHeaders(Ljava/lang/String;Ljava/util/Map;[B)Lcom/google/glass/net/PendingHttpRequest;
    ...
    .line 262
    sget-object v3, Lcom/google/glass/net/upload/ScottyHelper$UploadCommand;->QUERY:Lcom/google/glass/net/upload/ScottyHelper$UploadCommand;

    if-ne p1, v3, :cond_2

    .line 263
    iget-object v3, v1, Lcom/google/glass/net/SimplifiedHttpResponse;->headers:Ljava/util/Map;
    ...
    .line 264
    invoke-static {v1}, Lcom/google/glass/net/upload/ScottyHelper;->getSessionStatus(Lcom/google/glass/net/SimplifiedHttpResponse;)Lcom/google/glass/net/upload/ScottyHelper$SessionStatus;

    move-result-object v3

    .line 269
    sget-object v4, Lcom/google/glass/net/upload/ScottyHelper$SessionStatus;->FINAL:Lcom/google/glass/net/upload/ScottyHelper$SessionStatus;
    ...
    iget-object v3, p0, Lcom/google/glass/net/upload/SessionManager;->fileMimeType:Ljava/lang/String;

    invoke-interface {v2, v1, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 251
    const-string v1, "X-Goog-Upload-Content-Length"

    iget-object v3, p0, Lcom/google/glass/net/upload/SessionManager;->streamToUpload:Ljava/io/FileInputStream;
    ...
    .line 252
    const-string v1, "X-Goog-Attachment-Source"

    iget-object v3, p0, Lcom/google/glass/net/upload/SessionManager;->source:Ljava/lang/String;
    ...
    .line 275
    :cond_2
    iget v3, v1, Lcom/google/glass/net/SimplifiedHttpResponse;->statusCode:I
    ...
    invoke-interface {v1}, Lcom/google/glass/auth/AuthUtils;->invalidateAuthToken()V
    ...
    invoke-interface {v1, v0, v2, v8}, Lcom/google/glass/net/HttpRequestDispatcher;->postWithHeaders(Ljava/lang/String;Ljava/util/Map;[B)Lcom/google/glass/net/PendingHttpRequest;
    ...
    const-string v3, "Credentials are invalid even after refresh: "
    ...
    invoke-direct {v1, v0}, Lorg/apache/http/auth/InvalidCredentialsException;-><init>(Ljava/lang/String;)V
