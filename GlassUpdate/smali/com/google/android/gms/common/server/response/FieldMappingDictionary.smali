...
.method constructor <init>(ILjava/util/ArrayList;Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;->Bq:Ljava/util/ArrayList;

    invoke-static {p2}, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;->b(Ljava/util/ArrayList;)Ljava/util/HashMap;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;->Bp:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;->Br:Ljava/lang/String;
...
.method private static b(Ljava/util/ArrayList;)Ljava/util/HashMap;
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/common/server/response/FieldMappingDictionary$Entry;->db()Ljava/util/HashMap;
...
.method public copyInternalFieldMappings()V
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;->Bp:Ljava/util/HashMap;
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;->Bp:Ljava/util/HashMap;
...
.method da()Ljava/util/ArrayList;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public getFieldMapping(Ljava/lang/Class;)Ljava/util/HashMap;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .prologue
    .local p1, "clazz":Ljava/lang/Class;, "Ljava/lang/Class<+Lcom/google/android/gms/common/server/response/FastJsonResponse;>;"
    iget-object v0, p0, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;->Bp:Ljava/util/HashMap;
...
.method public getRootClassName()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;->Br:Ljava/lang/String;
...
.method public put(Ljava/lang/Class;Ljava/util/HashMap;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .prologue
    .local p1, "clazz":Ljava/lang/Class;, "Ljava/lang/Class<+Lcom/google/android/gms/common/server/response/FastJsonResponse;>;"
    .local p2, "fieldMap":Ljava/util/HashMap;, "Ljava/util/HashMap<Ljava/lang/String;Lcom/google/android/gms/common/server/response/FastJsonResponse$Field<**>;>;"
    iget-object v0, p0, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;->Bp:Ljava/util/HashMap;
