...
.method public static a()Lcom/google/common/base/ai;
    .locals 1
    ...
    invoke-virtual {v0}, Lcom/google/common/base/Predicates$ObjectPredicate;->withNarrowedType()Lcom/google/common/base/ai;
...
.method public static a(Lcom/google/common/base/ai;)Lcom/google/common/base/ai;
    ...
    invoke-direct {v0, p0}, Lcom/google/common/base/Predicates$NotPredicate;-><init>(Lcom/google/common/base/ai;)V

    return-object v0
.end method

.method public static a(Lcom/google/common/base/ai;Lcom/google/common/base/ai;)Lcom/google/common/base/ai;
    .locals 3
    ...
    invoke-static {v0, v1}, Lcom/google/common/base/Predicates;->b(Lcom/google/common/base/ai;Lcom/google/common/base/ai;)Ljava/util/List;

    move-result-object v0

    const/4 v1, 0x0

    invoke-direct {v2, v0, v1}, Lcom/google/common/base/Predicates$AndPredicate;-><init>(Ljava/util/List;Lcom/google/common/base/aj;)V
...
.method public static a(Ljava/lang/Object;)Lcom/google/common/base/ai;
    ...
    invoke-static {}, Lcom/google/common/base/Predicates;->c()Lcom/google/common/base/ai;
    ...
    invoke-direct {v0, p0, v1}, Lcom/google/common/base/Predicates$IsEqualToPredicate;-><init>(Ljava/lang/Object;Lcom/google/common/base/aj;)V

    goto :goto_0
.end method

.method public static a(Ljava/util/Collection;)Lcom/google/common/base/ai;
    .locals 2
    ...
    invoke-direct {v0, p0, v1}, Lcom/google/common/base/Predicates$InPredicate;-><init>(Ljava/util/Collection;Lcom/google/common/base/aj;)V

    return-object v0
.end method

.method public static varargs a([Lcom/google/common/base/ai;)Lcom/google/common/base/ai;
    .locals 3
    ...
    invoke-direct {v0, v1, v2}, Lcom/google/common/base/Predicates$AndPredicate;-><init>(Ljava/util/List;Lcom/google/common/base/aj;)V
...
.method private static b(Lcom/google/common/base/ai;Lcom/google/common/base/ai;)Ljava/util/List;
    .locals 2
...
.method private static c()Lcom/google/common/base/ai;
    .locals 1
