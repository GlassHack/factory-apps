...
.field private final SH:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private SI:Lcom/google/android/gms/common/api/ResultCallback;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private volatile SJ:Lcom/google/android/gms/common/api/Result;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "TR;"
        }
...
.field private SN:Lcom/google/android/gms/common/internal/ICancelToken;
...
.field private final mz:Ljava/util/concurrent/CountDownLatch;
...
.method protected constructor <init>(Landroid/os/Looper;)V
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/api/AbstractPendingResult;->SG:Ljava/lang/Object;
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/api/AbstractPendingResult;->mz:Ljava/util/concurrent/CountDownLatch;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/common/api/AbstractPendingResult;->SH:Ljava/util/ArrayList;
...
.method private a(Lcom/google/android/gms/common/api/Result;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/AbstractPendingResult;->SJ:Lcom/google/android/gms/common/api/Result;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/google/android/gms/common/api/AbstractPendingResult;->SN:Lcom/google/android/gms/common/internal/ICancelToken;

    iget-object v0, p0, Lcom/google/android/gms/common/api/AbstractPendingResult;->mz:Ljava/util/concurrent/CountDownLatch;

    invoke-virtual {v0}, Ljava/util/concurrent/CountDownLatch;->countDown()V

    iget-object v0, p0, Lcom/google/android/gms/common/api/AbstractPendingResult;->SJ:Lcom/google/android/gms/common/api/Result;

    invoke-interface {v0}, Lcom/google/android/gms/common/api/Result;->getStatus()Lcom/google/android/gms/common/api/Status;

    move-result-object v1

    iget-object v0, p0, Lcom/google/android/gms/common/api/AbstractPendingResult;->SI:Lcom/google/android/gms/common/api/ResultCallback;
    ...
    iget-boolean v0, p0, Lcom/google/android/gms/common/api/AbstractPendingResult;->SL:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Lcom/google/android/gms/common/api/AbstractPendingResult;->mHandler:Lcom/google/android/gms/common/api/AbstractPendingResult$CallbackHandler;

    iget-object v2, p0, Lcom/google/android/gms/common/api/AbstractPendingResult;->SI:Lcom/google/android/gms/common/api/ResultCallback;

    invoke-direct {p0}, Lcom/google/android/gms/common/api/AbstractPendingResult;->im()Lcom/google/android/gms/common/api/Result;
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/gms/common/api/AbstractPendingResult;->SH:Ljava/util/ArrayList;
    ...
    invoke-interface {v0, v1}, Lcom/google/android/gms/common/api/PendingResult$BatchCallback;->r(Lcom/google/android/gms/common/api/Status;)V
...
.method private im()Lcom/google/android/gms/common/api/Result;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()TR;"
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/api/AbstractPendingResult;->SG:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-boolean v2, p0, Lcom/google/android/gms/common/api/AbstractPendingResult;->SK:Z
    ...
    iput-object v2, p0, Lcom/google/android/gms/common/api/AbstractPendingResult;->SJ:Lcom/google/android/gms/common/api/Result;

    const/4 v2, 0x0

    iput-object v2, p0, Lcom/google/android/gms/common/api/AbstractPendingResult;->SI:Lcom/google/android/gms/common/api/ResultCallback;

    const/4 v2, 0x1

    iput-boolean v2, p0, Lcom/google/android/gms/common/api/AbstractPendingResult;->SK:Z
...
.method private in()V
    ...
    sget-object v0, Lcom/google/android/gms/common/api/Status;->TP:Lcom/google/android/gms/common/api/Status;
    ...
    iput-boolean v0, p0, Lcom/google/android/gms/common/api/AbstractPendingResult;->SM:Z
...
.method public final addBatchCallback(Lcom/google/android/gms/common/api/PendingResult$BatchCallback;)V
    ...
    .prologue
    .local p0, "this":Lcom/google/android/gms/common/api/AbstractPendingResult;, "Lcom/google/android/gms/common/api/AbstractPendingResult<TR;>;"
    iget-boolean v0, p0, Lcom/google/android/gms/common/api/AbstractPendingResult;->SK:Z
    ...
    invoke-interface {p1, v0}, Lcom/google/android/gms/common/api/PendingResult$BatchCallback;->r(Lcom/google/android/gms/common/api/Status;)V
...
.method public final await()Lcom/google/android/gms/common/api/Result;
    ...
    invoke-direct {p0}, Lcom/google/android/gms/common/api/AbstractPendingResult;->in()V
...
.method public final await(JLjava/util/concurrent/TimeUnit;)Lcom/google/android/gms/common/api/Result;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/common/api/AbstractPendingResult;->io()V
    :try_end_0
    .catch Ljava/lang/InterruptedException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public cancel()V
    ...
    :cond_1
    iget-object v0, p0, Lcom/google/android/gms/common/api/AbstractPendingResult;->SN:Lcom/google/android/gms/common/internal/ICancelToken;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/api/AbstractPendingResult;->SI:Lcom/google/android/gms/common/api/ResultCallback;

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/google/android/gms/common/api/AbstractPendingResult;->SL:Z

    sget-object v0, Lcom/google/android/gms/common/api/Status;->TS:Lcom/google/android/gms/common/api/Status;
...
.method io()V
    ...
    sget-object v0, Lcom/google/android/gms/common/api/Status;->TR:Lcom/google/android/gms/common/api/Status;
...
.method protected final setCancelToken(Lcom/google/android/gms/common/internal/ICancelToken;)V
    ...
    :try_start_0
    iput-object p1, p0, Lcom/google/android/gms/common/api/AbstractPendingResult;->SN:Lcom/google/android/gms/common/internal/ICancelToken;
...
.method public final setResult(Lcom/google/android/gms/common/api/Result;)V
    ...
    iget-object v3, p0, Lcom/google/android/gms/common/api/AbstractPendingResult;->SG:Ljava/lang/Object;

    monitor-enter v3

    :try_start_0
    iget-boolean v2, p0, Lcom/google/android/gms/common/api/AbstractPendingResult;->SM:Z

    if-nez v2, :cond_0

    iget-boolean v2, p0, Lcom/google/android/gms/common/api/AbstractPendingResult;->SL:Z
...
.method public final setResultCallback(Lcom/google/android/gms/common/api/ResultCallback;)V
    ...
    :cond_2
    :try_start_1
    iput-object p1, p0, Lcom/google/android/gms/common/api/AbstractPendingResult;->SI:Lcom/google/android/gms/common/api/ResultCallback;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
