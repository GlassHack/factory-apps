...
.field private static Vg:Ljava/util/HashSet;
...
.field private static Vh:Lcom/google/android/gms/common/images/ImageManager;

.field private static Vi:Lcom/google/android/gms/common/images/ImageManager;


# instance fields
.field private final Vj:Ljava/util/concurrent/ExecutorService;

.field private final Vk:Lcom/google/android/gms/common/images/ImageManager$b;

.field private final Vl:Lcom/google/android/gms/internal/jy;
...
.field private final Vo:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map",
            "<",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/common/images/ImageManager;->Vf:Ljava/lang/Object;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    sput-object v0, Lcom/google/android/gms/common/images/ImageManager;->Vg:Ljava/util/HashSet;
...
.method private constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->Vj:Ljava/util/concurrent/ExecutorService;
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->Vk:Lcom/google/android/gms/common/images/ImageManager$b;
    ...
    invoke-direct {p0}, Lcom/google/android/gms/common/images/ImageManager;->iO()V
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->Vl:Lcom/google/android/gms/internal/jy;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->Vm:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->Vn:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->Vo:Ljava/util/Map;
...
.method private a(Lcom/google/android/gms/common/images/a$a;)Landroid/graphics/Bitmap;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->Vk:Lcom/google/android/gms/common/images/ImageManager$b;
...
.method static synthetic a(Lcom/google/android/gms/common/images/ImageManager;)Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->Vm:Ljava/util/Map;
...
.method public static c(Landroid/content/Context;Z)Lcom/google/android/gms/common/images/ImageManager;
    ...
    sget-object v0, Lcom/google/android/gms/common/images/ImageManager;->Vi:Lcom/google/android/gms/common/images/ImageManager;
    ...
    sput-object v0, Lcom/google/android/gms/common/images/ImageManager;->Vi:Lcom/google/android/gms/common/images/ImageManager;
    ...
    :cond_1
    sget-object v0, Lcom/google/android/gms/common/images/ImageManager;->Vh:Lcom/google/android/gms/common/images/ImageManager;
    ...
    sput-object v0, Lcom/google/android/gms/common/images/ImageManager;->Vh:Lcom/google/android/gms/common/images/ImageManager;
...
.method static synthetic c(Lcom/google/android/gms/common/images/ImageManager;)Lcom/google/android/gms/internal/jy;
    .locals 1

    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->Vl:Lcom/google/android/gms/internal/jy;
...
.method static synthetic d(Lcom/google/android/gms/common/images/ImageManager;)Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->Vo:Ljava/util/Map;
...
.method static synthetic e(Lcom/google/android/gms/common/images/ImageManager;)Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->Vn:Ljava/util/Map;
...
.method static synthetic f(Lcom/google/android/gms/common/images/ImageManager;)Ljava/util/concurrent/ExecutorService;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->Vj:Ljava/util/concurrent/ExecutorService;
...
.method private iO()V
    ...
    iget-object v2, p0, Lcom/google/android/gms/common/images/ImageManager;->Vk:Lcom/google/android/gms/common/images/ImageManager$b;
...
.method static synthetic iP()Ljava/lang/Object;
    ...
    sget-object v0, Lcom/google/android/gms/common/images/ImageManager;->Vf:Ljava/lang/Object;

    return-object v0
.end method

.method static synthetic iQ()Ljava/util/HashSet;
    .locals 1

    sget-object v0, Lcom/google/android/gms/common/images/ImageManager;->Vg:Ljava/util/HashSet;
...
.method public a(Lcom/google/android/gms/common/images/a;)V
    ...
    invoke-static {v0}, Lcom/google/android/gms/common/internal/b;->bk(Ljava/lang/String;)V
...
.method public loadImage(Landroid/widget/ImageView;Landroid/net/Uri;I)V
    ...
    invoke-virtual {v0, p3}, Lcom/google/android/gms/common/images/a;->di(I)V
