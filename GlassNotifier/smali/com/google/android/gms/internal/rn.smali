...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/internal/rn;->aFn:[Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Lcom/google/android/gms/internal/rm$d;ZILandroid/os/Bundle;Landroid/os/Bundle;Ljava/lang/String;)V
    ...
    invoke-direct/range {p0 .. p7}, Lcom/google/android/gms/internal/rm;-><init>(Landroid/content/Context;Lcom/google/android/gms/internal/rm$d;ZILandroid/os/Bundle;Landroid/os/Bundle;Ljava/lang/String;)V

    return-void
.end method

.method private rJ()Ljava/lang/String;
    .locals 8
    ...
    iget-boolean v0, p0, Lcom/google/android/gms/internal/rn;->aFa:Z
    ...
    iget-object v0, p0, Lcom/google/android/gms/internal/rn;->mContext:Landroid/content/Context;
    ...
    sget-object v2, Lcom/google/android/gms/internal/rn;->aFn:[Ljava/lang/String;

    invoke-direct {p0}, Lcom/google/android/gms/internal/rn;->rK()Ljava/lang/String;
...
.method private rK()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/internal/rn;->rC()Lcom/google/android/gms/common/data/DataHolder;
    ...
    invoke-direct {v2, v0}, Lcom/google/android/gms/internal/rm$c;-><init>(Lcom/google/android/gms/common/data/DataHolder;)V

    const/4 v0, 0x1

    :goto_0
    invoke-virtual {v2}, Lcom/google/android/gms/internal/rm$c;->moveToNext()Z
    ...
    invoke-virtual {v2, v3}, Lcom/google/android/gms/internal/rm$c;->getString(Ljava/lang/String;)Ljava/lang/String;
...
.method protected a(Lcom/google/android/gms/internal/rm$c;Lcom/google/android/gms/internal/rm$c;Landroid/database/Cursor;)Lcom/google/android/gms/internal/rj;
    ...
    iget-object v1, p0, Lcom/google/android/gms/internal/rn;->aFb:Lcom/google/android/gms/internal/rg;

    const-string v2, "people-map start"

    invoke-virtual {v1, v2}, Lcom/google/android/gms/internal/rg;->de(Ljava/lang/String;)V

    invoke-static {p1, v4}, Lcom/google/android/gms/internal/rn;->a(Lcom/google/android/gms/internal/rm$c;Ljava/util/HashMap;)V
    ...
    new-instance v9, Lcom/google/android/gms/internal/rh;

    invoke-direct {v9}, Lcom/google/android/gms/internal/rh;-><init>()V

    new-instance v10, Lcom/google/android/gms/internal/qu;

    invoke-direct {v10}, Lcom/google/android/gms/internal/qu;-><init>()V

    new-instance v8, Ljava/util/HashMap;

    invoke-direct {v8}, Ljava/util/HashMap;-><init>()V

    invoke-virtual {p0, p2, v8}, Lcom/google/android/gms/internal/rn;->b(Lcom/google/android/gms/internal/rm$c;Ljava/util/HashMap;)V
    ...
    invoke-virtual {p0, p3, v9, v10, v8}, Lcom/google/android/gms/internal/rn;->a(Landroid/database/Cursor;Lcom/google/android/gms/internal/rh;Lcom/google/android/gms/internal/qu;Ljava/util/HashMap;)I

    move-result v1

    iget-object v2, p0, Lcom/google/android/gms/internal/rn;->aFb:Lcom/google/android/gms/internal/rg;

    const-string v3, "contact-map finish"

    invoke-virtual {v2, v3}, Lcom/google/android/gms/internal/rg;->de(Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/gms/internal/rn;->aFb:Lcom/google/android/gms/internal/rg;
    ...
    :cond_1
    :goto_0
    invoke-virtual {p1}, Lcom/google/android/gms/internal/rm$c;->isAfterLast()Z
    ...
    iget-object v3, p0, Lcom/google/android/gms/internal/rn;->mContext:Landroid/content/Context;

    invoke-virtual {v5}, Lcom/google/android/gms/internal/qv;->size()I

    move-result v4

    iget v9, p0, Lcom/google/android/gms/internal/rn;->aCF:I

    iget-object v10, p0, Lcom/google/android/gms/internal/rn;->aEY:Landroid/os/Bundle;

    iget-object v11, p0, Lcom/google/android/gms/internal/rn;->aEZ:Landroid/os/Bundle;
    ...
    invoke-virtual {p0, v2, v1}, Lcom/google/android/gms/internal/rn;->M(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {p1, v2}, Lcom/google/android/gms/internal/rm$c;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v5, v1}, Lcom/google/android/gms/internal/qv;->jw(I)V

    invoke-virtual {v7, v2}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    if-eqz v2, :cond_5

    invoke-virtual {v9, v2}, Lcom/google/android/gms/internal/rh;->df(Ljava/lang/String;)I
    ...
    invoke-virtual {v10, v1}, Lcom/google/android/gms/internal/qu;->jv(I)I
    ...
    invoke-virtual {v6, v1}, Lcom/google/android/gms/internal/qv;->jw(I)V
    ...
    :cond_c
    invoke-virtual {v6, v9, v2}, Lcom/google/android/gms/internal/qv;->a(Lcom/google/android/gms/internal/rh;Ljava/lang/String;)V
    ...
    invoke-virtual {v10, v1, v0}, Lcom/google/android/gms/internal/qu;->w(II)Ljava/lang/String;
...
.method protected rF()Landroid/database/Cursor;
    ...
    invoke-direct {p0}, Lcom/google/android/gms/internal/rn;->rJ()Ljava/lang/String;
    ...
    :cond_1
    sget-boolean v0, Lcom/google/android/gms/internal/rn;->aFh:Z
    ...
    iget-boolean v0, p0, Lcom/google/android/gms/internal/rn;->aCC:Z
    ...
    invoke-virtual {v3, v2}, Lcom/google/android/gms/internal/rf;->dc(Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/internal/rn;->mContext:Landroid/content/Context;
