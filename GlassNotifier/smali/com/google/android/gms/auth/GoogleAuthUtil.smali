...
.field private static final GZ:Landroid/content/ComponentName;

.field private static final Ha:Landroid/content/ComponentName;
...
.field public static final SIDEWINDER_ACCOUNT_TYPE:Ljava/lang/String; = "com.sidewinder"
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/auth/GoogleAuthUtil;->GZ:Landroid/content/ComponentName;
    ...
    sput-object v0, Lcom/google/android/gms/auth/GoogleAuthUtil;->Ha:Landroid/content/ComponentName;
...
.method public static clearToken(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {v1}, Lcom/google/android/gms/common/internal/u;->bl(Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lcom/google/android/gms/common/internal/k;->M(Landroid/content/Context;)Lcom/google/android/gms/common/internal/k;

    move-result-object v3

    sget-object v0, Lcom/google/android/gms/auth/GoogleAuthUtil;->GZ:Landroid/content/ComponentName;
    ...
    :try_start_0
    invoke-virtual {v2}, Lcom/google/android/gms/common/a;->if()Landroid/os/IBinder;
    ...
    sget-object v1, Lcom/google/android/gms/auth/GoogleAuthUtil;->GZ:Landroid/content/ComponentName;
...
.method public static fetchCurrentRecoveryData(Landroid/content/Context;Ljava/lang/String;)Lcom/google/android/gms/auth/RecoveryReadResponse;
    ...
    invoke-static {p0}, Lcom/google/android/gms/common/internal/k;->M(Landroid/content/Context;)Lcom/google/android/gms/common/internal/k;

    move-result-object v2

    sget-object v0, Lcom/google/android/gms/auth/GoogleAuthUtil;->Ha:Landroid/content/ComponentName;
    ...
    invoke-interface {v0, p1, v3}, Lcom/google/android/gms/internal/s;->a(Ljava/lang/String;Ljava/lang/String;)Lcom/google/android/gms/auth/RecoveryReadResponse;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/lang/InterruptedException; {:try_start_0 .. :try_end_0} :catch_1
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    sget-object v3, Lcom/google/android/gms/auth/GoogleAuthUtil;->Ha:Landroid/content/ComponentName;
    ...
    sget-object v2, Lcom/google/android/gms/auth/GoogleAuthUtil;->Ha:Landroid/content/ComponentName;
...
.method public static getAccountChangeEvents(Landroid/content/Context;ILjava/lang/String;)Ljava/util/List;
    ...
    invoke-static {v0}, Lcom/google/android/gms/common/internal/u;->bl(Ljava/lang/String;)V
    ...
    sget-object v3, Lcom/google/android/gms/auth/GoogleAuthUtil;->GZ:Landroid/content/ComponentName;
...
.method public static getRecoveryDetails(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Z)Lcom/google/android/gms/auth/RecoveryDecision;
    ...
    invoke-virtual {v2, v3, v1, v4}, Lcom/google/android/gms/common/internal/k;->a(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)Z
    ...
    invoke-static {v3}, Lcom/google/android/gms/internal/s$a;->b(Landroid/os/IBinder;)Lcom/google/android/gms/internal/s;

    move-result-object v3

    invoke-interface {v3, p1, p2, p3, v0}, Lcom/google/android/gms/internal/s;->a(Ljava/lang/String;Ljava/lang/String;ZLandroid/os/Bundle;)Lcom/google/android/gms/auth/RecoveryDecision;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/lang/InterruptedException; {:try_start_0 .. :try_end_0} :catch_1
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static getToken(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-static {p0, p1, p2, p3, v0}, Lcom/google/android/gms/auth/GoogleAuthUtil;->getToken(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;Ljava/lang/Boolean;)Ljava/lang/String;
...
.method public static getToken(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;Ljava/lang/Boolean;)Ljava/lang/String;
    .locals 6
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "accountName"    # Ljava/lang/String;
    .param p2, "scope"    # Ljava/lang/String;
    .param p3, "extras"    # Landroid/os/Bundle;
    .param p4, "useCache"    # Ljava/lang/Boolean;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
            Lcom/google/android/gms/auth/UserRecoverableAuthException;,
    ...
    invoke-static {v2}, Lcom/google/android/gms/common/internal/u;->bl(Ljava/lang/String;)V
    ...
    invoke-static {v1}, Lcom/google/android/gms/common/internal/k;->M(Landroid/content/Context;)Lcom/google/android/gms/common/internal/k;
    ...
    invoke-virtual {v3, v1, v2, v4}, Lcom/google/android/gms/common/internal/k;->a(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)Z
    ...
    sget-object v4, Lcom/google/android/gms/auth/GoogleAuthUtil;->GZ:Landroid/content/ComponentName;

    const-string v5, "GoogleAuthUtil"

    invoke-virtual {v3, v4, v2, v5}, Lcom/google/android/gms/common/internal/k;->b(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v1, v2, v5}, Lcom/google/android/gms/common/internal/k;->b(Landroid/content/ComponentName;Landroid/content/ServiceConnection;Ljava/lang/String;)V
...
.method public static updateRecoveryData(Landroid/content/Context;Lcom/google/android/gms/auth/RecoveryWriteRequest;)Lcom/google/android/gms/auth/RecoveryWriteResponse;
    ...
    invoke-interface {v0, p1, v3}, Lcom/google/android/gms/internal/s;->a(Lcom/google/android/gms/auth/RecoveryWriteRequest;Ljava/lang/String;)Lcom/google/android/gms/auth/RecoveryWriteResponse;
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/lang/InterruptedException; {:try_start_0 .. :try_end_0} :catch_1
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
