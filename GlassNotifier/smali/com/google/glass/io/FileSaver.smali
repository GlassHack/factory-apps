.class public Lcom/google/glass/io/FileSaver;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/google/glass/io/FileSaver$Saver;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 21
    const-class v0, Lcom/google/glass/io/FileSaver;

    invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lcom/google/glass/io/FileSaver;->TAG:Ljava/lang/String;

    .line 22
    sget-object v0, Lcom/google/glass/io/FileSaver;->TAG:Ljava/lang/String;

    invoke-static {v0}, Lcom/google/glass/logging/FormattingLoggers;->getLogger(Ljava/lang/String;)Lcom/google/glass/logging/FormattingLogger;

    move-result-object v0

    sput-object v0, Lcom/google/glass/io/FileSaver;->logger:Lcom/google/glass/logging/FormattingLogger;
...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/google/glass/io/FileSaver;->dir:Ljava/io/File;

    .line 159
    iget-object v0, p0, Lcom/google/glass/io/FileSaver;->dir:Ljava/io/File;
    ...
    .line 160
    sget-object v0, Lcom/google/glass/io/FileSaver;->logger:Lcom/google/glass/logging/FormattingLogger;

    const-string v1, "Directory told to manage, %s, does not exist -- making it!"

    new-array v2, v5, [Ljava/lang/Object;

    iget-object v3, p0, Lcom/google/glass/io/FileSaver;->dir:Ljava/io/File;
...
.method static synthetic access$000(Ljava/io/File;Ljava/io/FileOutputStream;)J
    ...
    .prologue
    .line 20
    invoke-static {p0, p1}, Lcom/google/glass/io/FileSaver;->copyWithChannels(Ljava/io/File;Ljava/io/FileOutputStream;)J
...
.method public static newSaver(Ljava/io/File;)Lcom/google/glass/io/FileSaver$Saver;
    .locals 1
    .param p0, "fileToSave"    # Ljava/io/File;

    .prologue
    .line 79
    new-instance v0, Lcom/google/glass/io/FileSaver$2;

    invoke-direct {v0, p0}, Lcom/google/glass/io/FileSaver$2;-><init>(Ljava/io/File;)V

    return-object v0
.end method

.method public static newSaver(Ljava/io/InputStream;)Lcom/google/glass/io/FileSaver$Saver;
    .locals 1
    .param p0, "streamToSave"    # Ljava/io/InputStream;

    .prologue
    .line 133
    new-instance v0, Lcom/google/glass/io/FileSaver$3;

    invoke-direct {v0, p0}, Lcom/google/glass/io/FileSaver$3;-><init>(Ljava/io/InputStream;)V

    return-object v0
.end method

.method public static newSaver([B)Lcom/google/glass/io/FileSaver$Saver;
    .locals 1
    .param p0, "content"    # [B

    .prologue
    .line 64
    new-instance v0, Lcom/google/glass/io/FileSaver$1;

    invoke-direct {v0, p0}, Lcom/google/glass/io/FileSaver$1;-><init>([B)V
...
.method public disableMockModifiedTimeForTest()V
    ...
    iput-object v0, p0, Lcom/google/glass/io/FileSaver;->mockModifiedTimeForTest:Ljava/util/concurrent/atomic/AtomicLong;
...
.method public getModifiedTime()J
    ...
    iget-object v2, p0, Lcom/google/glass/io/FileSaver;->mockModifiedTimeForTest:Ljava/util/concurrent/atomic/AtomicLong;
...
.method public write(Lcom/google/glass/io/FileSaver$Saver;Ljava/lang/String;)Z
    .locals 13
    .param p1, "saver"    # Lcom/google/glass/io/FileSaver$Saver;
    ...
    invoke-virtual {p0, v1}, Lcom/google/glass/io/FileSaver;->getTempFile(Ljava/io/File;)Ljava/io/File;
    ...
    invoke-virtual {p0}, Lcom/google/glass/io/FileSaver;->getModifiedTime()J
    ...
    .line 185
    sget-object v8, Lcom/google/glass/io/FileSaver;->logger:Lcom/google/glass/logging/FormattingLogger;
    ...
    :try_start_3
    invoke-interface {p1, v5}, Lcom/google/glass/io/FileSaver$Saver;->save(Ljava/io/OutputStream;)V
    ...
    .line 213
    .restart local v0    # "e":Ljava/io/IOException;
    sget-object v9, Lcom/google/glass/io/FileSaver;->logger:Lcom/google/glass/logging/FormattingLogger;
