...
.method public run()V
    ...
    iget-object v3, v1, Lcom/google/glass/timeline/TimelineNotificationHelper$NotifyParameters;->item:Lcom/google/googlex/glass/common/proto/nano/TimelineItem;

    invoke-virtual {v3}, Lcom/google/googlex/glass/common/proto/nano/TimelineItem;->getId()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v0, v3}, Lcom/google/glass/timeline/TimelineItemDatabaseHelper;->queryTimelineItem(Ljava/lang/String;)Lcom/google/googlex/glass/common/proto/nano/TimelineItem;

    move-result-object v2

    .line 89
    .local v2, "refreshedItem":Lcom/google/googlex/glass/common/proto/nano/TimelineItem;
    if-eqz v2, :cond_1
    ...
    invoke-virtual {v3, v4, v2, v5}, Lcom/google/glass/timeline/TimelineNotificationHelper;->notifyInternal(Landroid/content/Context;Lcom/google/googlex/glass/common/proto/nano/TimelineItem;I)V

    .line 96
    .end local v0    # "databaseHelper":Lcom/google/glass/timeline/TimelineItemDatabaseHelper;
    .end local v2    # "refreshedItem":Lcom/google/googlex/glass/common/proto/nano/TimelineItem;
    :cond_0
    :goto_0
    return-void
    ...
    .restart local v2    # "refreshedItem":Lcom/google/googlex/glass/common/proto/nano/TimelineItem;
    :cond_1
