...
.method public extractInstalledGlasswaresFromCursor(Landroid/database/Cursor;)Ljava/util/List;
    ...
    .line 58
    .local v1, "results":Ljava/util/List;, "Ljava/util/List<Lcom/google/googlex/glass/common/proto/nano/InstalledGlassware;>;"
    if-eqz p1, :cond_2
    ...
    .line 61
    :cond_0
    invoke-static {p1}, Lcom/google/glass/boutique/BoutiqueUtils;->fromCursor(Landroid/database/Cursor;)Lcom/google/googlex/glass/common/proto/nano/InstalledGlassware;

    move-result-object v0

    .line 62
    .local v0, "result":Lcom/google/googlex/glass/common/proto/nano/InstalledGlassware;
    if-eqz v0, :cond_1
    ...
    .line 68
    .end local v0    # "result":Lcom/google/googlex/glass/common/proto/nano/InstalledGlassware;
    :cond_2
    return-object v1
.end method
...
.method public queryGlasswareBySource(Landroid/content/ContentResolver;Ljava/lang/String;)Lcom/google/googlex/glass/common/proto/nano/InstalledGlassware;
    .locals 9
    .param p1, "resolver"    # Landroid/content/ContentResolver;
    ...
    .line 86
    invoke-static {v6}, Lcom/google/glass/boutique/BoutiqueUtils;->fromCursor(Landroid/database/Cursor;)Lcom/google/googlex/glass/common/proto/nano/InstalledGlassware;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public queryInstalledGlasswareByGlasswareId(Landroid/content/ContentResolver;Ljava/lang/Long;)Lcom/google/googlex/glass/common/proto/nano/InstalledGlassware;
    .locals 10
    .param p1, "resolver"    # Landroid/content/ContentResolver;
