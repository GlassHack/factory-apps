...
.method notifyInternal(Landroid/content/Context;Lcom/google/googlex/glass/common/proto/TimelineNano$TimelineItem;I)V
    ...
    invoke-static {v5}, Lcom/google/glass/nowtown/NowTownUtils;->isNowTownEnabled(Landroid/content/ContentResolver;)Z
    ...
    const-string v6, "Suppressing legacy notification as NowTown is active."
    ...
    .line 156
    .local v1, "cover":Landroid/util/Pair;, "Landroid/util/Pair<Lcom/google/googlex/glass/common/proto/TimelineNano$TimelineItem;Ljava/lang/Integer;>;"
    if-nez v1, :cond_2
    ...
    .line 177
    .end local v1    # "cover":Landroid/util/Pair;, "Landroid/util/Pair<Lcom/google/googlex/glass/common/proto/TimelineNano$TimelineItem;Ljava/lang/Integer;>;"
    ...
    invoke-direct {v6, v3}, Lcom/google/glass/timeline/TimelineItemId;-><init>(Lcom/google/googlex/glass/common/proto/TimelineNano$TimelineItem;)V
    ...
    invoke-direct {v6, v0}, Lcom/google/glass/timeline/TimelineItemId;-><init>(Lcom/google/googlex/glass/common/proto/TimelineNano$TimelineItem;)V
    ...
    .line 167
    .end local v0    # "bundleTimelineItem":Lcom/google/googlex/glass/common/proto/TimelineNano$TimelineItem;
    .end local v2    # "intent":Landroid/content/Intent;
    .restart local v1    # "cover":Landroid/util/Pair;, "Landroid/util/Pair<Lcom/google/googlex/glass/common/proto/TimelineNano$TimelineItem;Ljava/lang/Integer;>;"
    .restart local v4    # "timelineItemId":Lcom/google/glass/timeline/TimelineItemId;
    :cond_4
    const/4 v0, 0x0

    .restart local v0    # "bundleTimelineItem":Lcom/google/googlex/glass/common/proto/TimelineNano$TimelineItem;
    goto :goto_1

    .line 172
    .end local v0    # "bundleTimelineItem":Lcom/google/googlex/glass/common/proto/TimelineNano$TimelineItem;
    .end local v1    # "cover":Landroid/util/Pair;, "Landroid/util/Pair<Lcom/google/googlex/glass/common/proto/TimelineNano$TimelineItem;Ljava/lang/Integer;>;"
    .end local v3    # "mainTimelineItem":Lcom/google/googlex/glass/common/proto/TimelineNano$TimelineItem;
    .end local v4    # "timelineItemId":Lcom/google/glass/timeline/TimelineItemId;
    :cond_5
    move-object v3, p2

    .line 173
    .restart local v3    # "mainTimelineItem":Lcom/google/googlex/glass/common/proto/TimelineNano$TimelineItem;
    const/4 v0, 0x0
