...
.method private maybeInitDispatcherProvider(Lcom/google/glass/inject/InitializableProvider;Ljava/lang/String;)V
    ...
    .line 248
    :cond_1
    iget-object v1, p0, Lcom/google/glass/app/GlassApplication;->authUtils:Lcom/google/glass/auth/AuthUtils;
    ...
    iput-object v1, p0, Lcom/google/glass/app/GlassApplication;->authUtils:Lcom/google/glass/auth/AuthUtils;
...
.method public onCreate()V
    ...
    .line 69
    new-instance v8, Lcom/google/glass/userevent/UserEventHelper;

    invoke-direct {v8, p0}, Lcom/google/glass/userevent/UserEventHelper;-><init>(Landroid/content/Context;)V

    iput-object v8, p0, Lcom/google/glass/app/GlassApplication;->userEventHelper:Lcom/google/glass/userevent/UserEventHelper;
    ...
    invoke-virtual {v8}, Lcom/google/glass/async/AsyncThreadExecutorManager$Provider;->get()Ljava/lang/Object;

    move-result-object v8

    check-cast v8, Lcom/google/glass/async/AsyncThreadExecutorManager;

    iget-object v9, p0, Lcom/google/glass/app/GlassApplication;->userEventHelper:Lcom/google/glass/userevent/UserEventHelper;

    .line 71
    invoke-virtual {v8, v9}, Lcom/google/glass/async/AsyncThreadExecutorManager;->setUserEventHelper(Lcom/google/glass/userevent/UserEventHelper;)V
    ...
    .line 75
    .local v6, "soundManagerProvider":Lcom/google/glass/sound/SoundManagerProvider;
    invoke-virtual {v6}, Lcom/google/glass/sound/SoundManagerProvider;->isInitialized()Z
    ...
    .line 76
    new-instance v8, Lcom/google/glass/sound/SoundManager;

    invoke-direct {v8, p0}, Lcom/google/glass/sound/SoundManager;-><init>(Landroid/content/Context;)V

    invoke-virtual {v6, v8}, Lcom/google/glass/sound/SoundManagerProvider;->init(Ljava/lang/Object;)V
    ...
    .line 80
    .local v7, "ttsHelperProvider":Lcom/google/glass/util/TtsHelperLazySingletonProvider;
    invoke-virtual {v7}, Lcom/google/glass/util/TtsHelperLazySingletonProvider;->isInitialized()Z
    ...
    .line 81
    new-instance v8, Lcom/google/glass/app/GlassApplication$1;

    invoke-direct {v8, p0}, Lcom/google/glass/app/GlassApplication$1;-><init>(Lcom/google/glass/app/GlassApplication;)V

    invoke-virtual {v7, v8}, Lcom/google/glass/util/TtsHelperLazySingletonProvider;->init(Lcom/google/common/base/Supplier;)V
    ...
    .line 91
    .local v0, "cachedBitmapFactoryProvider":Lcom/google/glass/util/CachedBitmapFactory$Provider;
    ...
    .line 92
    new-instance v8, Lcom/google/glass/app/GlassApplication$2;

    invoke-direct {v8, p0}, Lcom/google/glass/app/GlassApplication$2;-><init>(Lcom/google/glass/app/GlassApplication;)V

    invoke-virtual {v0, v8}, Lcom/google/glass/util/CachedBitmapFactory$Provider;->init(Lcom/google/common/base/Supplier;)V
    ...
    .line 101
    .local v2, "hasherProvider":Lcom/google/glass/logging/PiiHasher$Provider;
    invoke-virtual {v2}, Lcom/google/glass/logging/PiiHasher$Provider;->isInitialized()Z
    ...
    .line 102
    new-instance v8, Lcom/google/glass/app/GlassApplication$3;

    invoke-direct {v8, p0}, Lcom/google/glass/app/GlassApplication$3;-><init>(Lcom/google/glass/app/GlassApplication;)V

    invoke-virtual {v2, v8}, Lcom/google/glass/logging/PiiHasher$Provider;->init(Lcom/google/common/base/Supplier;)V
    ...
    .line 116
    .local v3, "primaryProtoRequestDispatcherProvider":Lcom/google/glass/inject/InitializableProvider;, "Lcom/google/glass/inject/InitializableProvider<Lcom/google/glass/net/ProtoRequestDispatcher;>;"
    const-string v8, "primary"

    invoke-direct {p0, v3, v8}, Lcom/google/glass/app/GlassApplication;->maybeInitDispatcherProvider(Lcom/google/glass/inject/InitializableProvider;Ljava/lang/String;)V
    ...
    .line 121
    .local v5, "secondaryProtoRequestDispatcherProvider":Lcom/google/glass/inject/InitializableProvider;, "Lcom/google/glass/inject/InitializableProvider<Lcom/google/glass/net/ProtoRequestDispatcher;>;"
    const-string v8, "secondary"

    invoke-direct {p0, v5, v8}, Lcom/google/glass/app/GlassApplication;->maybeInitDispatcherProvider(Lcom/google/glass/inject/InitializableProvider;Ljava/lang/String;)V
    ...
    .line 127
    .local v4, "protoRequestDispatcherPoolProvider":Lcom/google/glass/net/ProtoRequestDispatcherPoolSingletonProvider;
    invoke-virtual {v4}, Lcom/google/glass/net/ProtoRequestDispatcherPoolSingletonProvider;->isInitialized()Z
    ...
    .line 128
    new-instance v8, Lcom/google/glass/net/ProtoRequestDispatcherPool;

    iget-object v9, p0, Lcom/google/glass/app/GlassApplication;->httpRequestDispatcher:Lcom/google/glass/net/AndroidHttpRequestDispatcher;

    iget-object v10, p0, Lcom/google/glass/app/GlassApplication;->authUtils:Lcom/google/glass/auth/AuthUtils;

    invoke-direct {v8, v9, v10}, Lcom/google/glass/net/ProtoRequestDispatcherPool;-><init>(Lcom/google/glass/net/HttpRequestDispatcher;Lcom/google/glass/auth/AuthUtils;)V

    invoke-virtual {v4, v8}, Lcom/google/glass/net/ProtoRequestDispatcherPoolSingletonProvider;->init(Ljava/lang/Object;)V
    ...
    invoke-virtual {v8}, Lcom/google/glass/util/CachedBitmapFactory$Provider;->get()Ljava/lang/Object;

    move-result-object v8

    check-cast v8, Lcom/google/glass/util/CachedBitmapFactory;

    invoke-static {p0, v8}, Lcom/google/glass/mosaic/MosaicHelper;->initialize(Landroid/content/Context;Lcom/google/glass/util/CachedBitmapFactory;)V
    ...
    new-instance v8, Lcom/google/glass/boutique/BoutiqueQueryHelper;

    invoke-direct {v8}, Lcom/google/glass/boutique/BoutiqueQueryHelper;-><init>()V

    invoke-direct {v1, v8}, Lcom/google/glass/entity/EntityHelper;-><init>(Lcom/google/glass/boutique/BoutiqueQueryHelper;)V
    ...
    .line 146
    new-instance v8, Lcom/google/glass/entity/EntityCache;

    invoke-direct {v8, p0}, Lcom/google/glass/entity/EntityCache;-><init>(Landroid/content/Context;)V

    invoke-static {v8}, Lcom/google/glass/entity/EntityCache;->setSharedInstance(Lcom/google/glass/entity/EntityCache;)V
    ...
    invoke-virtual {v8}, Lcom/google/glass/async/AsyncThreadExecutorManager;->getThreadPoolExecutor()Lcom/google/glass/async/AsyncThreadExecutorManager$QueueExecutor;

    move-result-object v8

    new-instance v9, Lcom/google/glass/app/GlassApplication$4;

    invoke-direct {v9, p0}, Lcom/google/glass/app/GlassApplication$4;-><init>(Lcom/google/glass/app/GlassApplication;)V

    invoke-interface {v8, v9}, Lcom/google/glass/async/AsyncThreadExecutorManager$QueueExecutor;->execute(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v8}, Lcom/google/glass/entity/EntityCache;->registerSyncChanged()V
    ...
    .line 169
    invoke-virtual {v8}, Landroid/os/StrictMode$ThreadPolicy$Builder;->detectAll()Landroid/os/StrictMode$ThreadPolicy$Builder;
    ...
    .line 172
    new-instance v8, Landroid/os/StrictMode$VmPolicy$Builder;

    invoke-direct {v8}, Landroid/os/StrictMode$VmPolicy$Builder;-><init>()V

    .line 173
    invoke-virtual {v8}, Landroid/os/StrictMode$VmPolicy$Builder;->detectAll()Landroid/os/StrictMode$VmPolicy$Builder;

    move-result-object v8

    .line 174
    invoke-virtual {v8}, Landroid/os/StrictMode$VmPolicy$Builder;->penaltyLog()Landroid/os/StrictMode$VmPolicy$Builder;

    move-result-object v8

    .line 175
    invoke-virtual {v8}, Landroid/os/StrictMode$VmPolicy$Builder;->build()Landroid/os/StrictMode$VmPolicy;

    move-result-object v8

    .line 172
    invoke-static {v8}, Landroid/os/StrictMode;->setVmPolicy(Landroid/os/StrictMode$VmPolicy;)V
