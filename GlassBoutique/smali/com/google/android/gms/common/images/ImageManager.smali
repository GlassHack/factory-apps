...
.field private static yE:Ljava/util/HashSet;
...
.field private static yF:Lcom/google/android/gms/common/images/ImageManager;

.field private static yG:Lcom/google/android/gms/common/images/ImageManager;
...
.field private final yH:Ljava/util/concurrent/ExecutorService;

.field private final yI:Lcom/google/android/gms/common/images/ImageManager$b;

.field private final yJ:Lcom/google/android/gms/internal/bf;
...
.field private final yL:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map",
            "<",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/common/images/ImageManager;->yD:Ljava/lang/Object;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    sput-object v0, Lcom/google/android/gms/common/images/ImageManager;->yE:Ljava/util/HashSet;
...
.method private constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->yH:Ljava/util/concurrent/ExecutorService;
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->yI:Lcom/google/android/gms/common/images/ImageManager$b;
    ...
    invoke-direct {p0}, Lcom/google/android/gms/common/images/ImageManager;->cE()V
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->yJ:Lcom/google/android/gms/internal/bf;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->yK:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->yL:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->yM:Ljava/util/Map;
...
.method private a(Lcom/google/android/gms/common/images/a$a;)Landroid/graphics/Bitmap;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->yI:Lcom/google/android/gms/common/images/ImageManager$b;
...
.method public static a(Landroid/content/Context;Z)Lcom/google/android/gms/common/images/ImageManager;
    ...
    sget-object v0, Lcom/google/android/gms/common/images/ImageManager;->yG:Lcom/google/android/gms/common/images/ImageManager;
    ...
    sput-object v0, Lcom/google/android/gms/common/images/ImageManager;->yG:Lcom/google/android/gms/common/images/ImageManager;
    ...
    :cond_1
    sget-object v0, Lcom/google/android/gms/common/images/ImageManager;->yF:Lcom/google/android/gms/common/images/ImageManager;
    ...
    sput-object v0, Lcom/google/android/gms/common/images/ImageManager;->yF:Lcom/google/android/gms/common/images/ImageManager;
...
.method static synthetic a(Lcom/google/android/gms/common/images/ImageManager;)Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->yK:Ljava/util/Map;
...
.method static synthetic c(Lcom/google/android/gms/common/images/ImageManager;)Lcom/google/android/gms/internal/bf;
    .locals 1

    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->yJ:Lcom/google/android/gms/internal/bf;
...
.method private cE()V
    ...
    iget-object v2, p0, Lcom/google/android/gms/common/images/ImageManager;->yI:Lcom/google/android/gms/common/images/ImageManager$b;
...
.method static synthetic cF()Ljava/lang/Object;
    .locals 1

    sget-object v0, Lcom/google/android/gms/common/images/ImageManager;->yD:Ljava/lang/Object;

    return-object v0
.end method

.method static synthetic cG()Ljava/util/HashSet;
    .locals 1

    sget-object v0, Lcom/google/android/gms/common/images/ImageManager;->yE:Ljava/util/HashSet;
...
.method static synthetic d(Lcom/google/android/gms/common/images/ImageManager;)Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->yM:Ljava/util/Map;
...
.method static synthetic e(Lcom/google/android/gms/common/images/ImageManager;)Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->yL:Ljava/util/Map;
...
.method static synthetic f(Lcom/google/android/gms/common/images/ImageManager;)Ljava/util/concurrent/ExecutorService;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->yH:Ljava/util/concurrent/ExecutorService;
...
.method public a(Lcom/google/android/gms/common/images/a;)V
    ...
    invoke-static {v0}, Lcom/google/android/gms/common/internal/a;->S(Ljava/lang/String;)V
...
.method public loadImage(Landroid/widget/ImageView;Landroid/net/Uri;I)V
    ...
    invoke-virtual {v0, p3}, Lcom/google/android/gms/common/images/a;->aU(I)V
