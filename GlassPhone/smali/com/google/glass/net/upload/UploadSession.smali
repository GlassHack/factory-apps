...
.method public upload()V
    ...
    iget-object v3, p0, Lcom/google/glass/net/upload/UploadSession;->pathToUpload:Ljava/lang/String;

    iget-wide v4, p0, Lcom/google/glass/net/upload/UploadSession;->lastModifiedMillis:J

    invoke-static {v0, v1, v3, v4, v5}, Lcom/google/glass/net/upload/ScottyHelper;->makeBaseHeaders(Lcom/google/glass/auth/AuthUtils;Lcom/google/glass/net/upload/ScottyHelper$UploadCommand;Ljava/lang/String;J)Ljava/util/Map;

    move-result-object v7

    .line 93
    .local v7, "baseHeaders":Ljava/util/Map;, "Ljava/util/Map<Ljava/lang/String;Ljava/lang/String;>;"
    ...
    const-string v1, "HTTP library attempted to repeat an upload. Likely causes: connectivity is bad, SSL failed, or Scotty failed?"
    ...
    .line 122
    :cond_1
    iget v0, v9, Lcom/google/glass/net/SimplifiedHttpResponse;->statusCode:I
    ...
    .line 133
    :cond_4
    iget-object v0, v9, Lcom/google/glass/net/SimplifiedHttpResponse;->headers:Ljava/util/Map;
    ...
    .line 144
    :cond_6
    iget-object v0, v9, Lcom/google/glass/net/SimplifiedHttpResponse;->body:[B
    ...
    invoke-virtual {v0, v9}, Lcom/google/glass/net/upload/SessionManager;->onUploadSuccess(Lcom/google/glass/net/SimplifiedHttpResponse;)V
