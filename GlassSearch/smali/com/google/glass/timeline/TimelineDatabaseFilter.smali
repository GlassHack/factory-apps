...
.source "TimelineDatabaseFilter.java"
...
.method private appendEntityQuery(Ljava/lang/StringBuilder;Z)V
    ...
    .prologue
    .line 49
    iget-object v2, p0, Lcom/google/glass/timeline/TimelineDatabaseFilter;->entity:Lcom/google/googlex/glass/common/proto/TimelineNano$Entity;
    ...
    invoke-static {v2}, Lcom/google/glass/entity/EntityUtils;->getIds(Lcom/google/googlex/glass/common/proto/TimelineNano$Entity;)[Ljava/lang/String;
    ...
    .line 56
    const-string v2, "_id IN (SELECT timelineId FROM entity WHERE entityId IN ("
...
.method public constructSqlQuery(Z)Ljava/lang/String;
    ...
    invoke-direct {p0, v0, p1}, Lcom/google/glass/timeline/TimelineDatabaseFilter;->appendEntityQuery(Ljava/lang/StringBuilder;Z)V
    ...
    :goto_0
    invoke-direct {p0, v0, v1}, Lcom/google/glass/timeline/TimelineDatabaseFilter;->appendSourceQuery(Ljava/lang/StringBuilder;Z)V
    ...
    :cond_2
    invoke-direct {p0, v0, v2}, Lcom/google/glass/timeline/TimelineDatabaseFilter;->appendAttributionType(Ljava/lang/StringBuilder;Z)V
