...
.method static synthetic access$000(Lcom/google/glass/timeline/ui/binder/TimelineCursorManager;)Ljava/util/concurrent/locks/Lock;
    .locals 1
    .param p0, "x0"    # Lcom/google/glass/timeline/ui/binder/TimelineCursorManager;
...
.method public getItemId(I)J
    ...
    .line 139
    :cond_1
    iget-object v6, p0, Lcom/google/glass/timeline/ui/binder/TimelineCursorManager;->cursorLock:Ljava/util/concurrent/locks/Lock;

    invoke-interface {v6}, Ljava/util/concurrent/locks/Lock;->lock()V

    .line 142
    :try_start_0
    iget-object v6, p0, Lcom/google/glass/timeline/ui/binder/TimelineCursorManager;->rowIdCache:Landroid/util/LruCache;
    ...
    .line 146
    iget-object v6, p0, Lcom/google/glass/timeline/ui/binder/TimelineCursorManager;->cursor:Landroid/database/Cursor;
    ...
    .line 150
    sget-object v6, Lcom/google/glass/timeline/ui/binder/TimelineCursorManager;->logger:Lcom/google/glass/logging/FormattingLogger;

    const-string v7, "Could not move cursor to position %d."
    ...
    :cond_4
    :try_start_2
    iget-object v4, p0, Lcom/google/glass/timeline/ui/binder/TimelineCursorManager;->serializationHelper:Lcom/google/glass/timeline/TimelineItemDatabaseSerializationHelper;

    iget-object v5, p0, Lcom/google/glass/timeline/ui/binder/TimelineCursorManager;->cursor:Landroid/database/Cursor;

    invoke-virtual {v4, v5}, Lcom/google/glass/timeline/TimelineItemDatabaseSerializationHelper;->getItemId(Landroid/database/Cursor;)Ljava/lang/String;
    ...
    invoke-virtual {v4, v5}, Lcom/google/glass/timeline/TimelineItemDatabaseSerializationHelper;->getCreationTime(Landroid/database/Cursor;)J

    move-result-wide v0

    .line 155
    .local v0, "creationTime":J
    invoke-virtual {p0, v2, v0, v1}, Lcom/google/glass/timeline/ui/binder/TimelineCursorManager;->calculateRowId(Ljava/lang/String;J)J
    ...
    .line 158
    iget-object v4, p0, Lcom/google/glass/timeline/ui/binder/TimelineCursorManager;->rowIdCache:Landroid/util/LruCache;
    ...
    iget-object v5, p0, Lcom/google/glass/timeline/ui/binder/TimelineCursorManager;->cursorLock:Ljava/util/concurrent/locks/Lock;
