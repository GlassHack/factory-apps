...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/google/glass/timeline/ui/TimelineActivity$WearHostCallbackSuccessReceiver;,
        Lcom/google/glass/timeline/ui/TimelineActivity$AndroidScreenOnResponseReceiver;
    }
.end annotation
...
.method static synthetic access$1000(Lcom/google/glass/timeline/ui/TimelineActivity;)Z
    .locals 1
    .param p0, "x0"    # Lcom/google/glass/timeline/ui/TimelineActivity;
...
.method private addMenuItems(Landroid/view/Menu;)Z
    ...
    invoke-virtual {v3}, Lcom/google/glass/timeline/ui/TimelineView;->getSelectedView()Landroid/view/View;
    ...
    .line 550
    .local v0, "selectedCard":Lcom/google/glass/widget/horizontalscroll/Card;
    if-eqz v0, :cond_0
    ...
    invoke-virtual {v3}, Lcom/google/glass/timeline/ui/TimelineView;->getSelectedItem()Ljava/lang/Object;
    ...
    .line 561
    .local v1, "selectedItem":Lcom/google/googlex/glass/common/proto/TimelineNano$TimelineItem;
    iget-object v3, p0, Lcom/google/glass/timeline/ui/TimelineActivity;->timelineMenuBuilder:Lcom/google/glass/timeline/TimelineMenuBuilder;

    invoke-virtual {p0}, Lcom/google/glass/timeline/ui/TimelineActivity;->canReadMore()Z

    move-result v4

    invoke-virtual {v3, p1, v1, v4}, Lcom/google/glass/timeline/TimelineMenuBuilder;->handlePrepareOptionsMenu(Landroid/view/Menu;Lcom/google/googlex/glass/common/proto/TimelineNano$TimelineItem;Z)Z
...
.method private ensureOnItemClickListener(Lcom/google/glass/timeline/ui/TimelineView;)V
    .locals 1
    .param p1, "timelineView"    # Lcom/google/glass/timeline/ui/TimelineView;
...
.method private ensureSelectionListener(Lcom/google/glass/timeline/ui/TimelineView;)V
    ...
    .line 290
    .local v0, "navigated":Ljava/util/BitSet;
    invoke-direct {p0}, Lcom/google/glass/timeline/ui/TimelineActivity;->shouldLogTimelineNavigation()Z
    ...
    .line 388
    .end local v0    # "navigated":Ljava/util/BitSet;
    :cond_1
    return-void
.end method
...
.method private handleShowGlassTips(Landroid/view/View;)V
    ...
    .prologue
    .line 262
    sget-object v1, Lcom/google/glass/util/Labs$Feature;->GT:Lcom/google/glass/util/Labs$Feature;
    ...
    :goto_1
    new-instance v2, Lcom/google/glass/timeline/ui/TimelineActivity$2;

    invoke-direct {v2, p0}, Lcom/google/glass/timeline/ui/TimelineActivity$2;-><init>(Lcom/google/glass/timeline/ui/TimelineActivity;)V

    invoke-virtual {p0, v1, v2}, Lcom/google/glass/timeline/ui/TimelineActivity;->scheduleToShowGlassTips(Lcom/google/glass/widget/GlassTipsManager$TipsType;Lcom/google/glass/widget/GlassTipsManager$TipsCondition;)V
...
.method private isBundleEntryPoint(Landroid/view/View;)Z
    ...
    .line 404
    .local v0, "isBundleEntryPoint":Ljava/lang/Boolean;
    if-eqz v0, :cond_0
...
.method private isWearConnected()Z
    ...
    sget-object v3, Lcom/google/glass/timeline/ui/TimelineActivity;->WEAR_CONNECTION_CHANGE_INTENT_FILTER:Landroid/content/IntentFilter;

    invoke-virtual {p0, v2, v3}, Lcom/google/glass/timeline/ui/TimelineActivity;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
...
.method private showWearOpeningOnPhoneDialog()V
    ...
    .line 770
    invoke-virtual {v2, v4}, Lcom/google/glass/widget/MessageDialog$Builder;->setKeepScreenOn(Z)Lcom/google/glass/widget/MessageDialog$Builder;

    move-result-object v2

    .line 771
    invoke-virtual {v2, v4}, Lcom/google/glass/widget/MessageDialog$Builder;->setShowProgress(Z)Lcom/google/glass/widget/MessageDialog$Builder;
    ...
    .line 774
    invoke-virtual {v2, v5}, Lcom/google/glass/widget/MessageDialog$Builder;->setDismissable(Z)Lcom/google/glass/widget/MessageDialog$Builder;

    move-result-object v2

    sget v3, Lcom/google/glass/common/R$string;->opening_on_phone:I
    ...
    sget v3, Lcom/google/glass/common/R$drawable;->ic_open_on_phone_64:I
    ...
    iput-object v2, p0, Lcom/google/glass/timeline/ui/TimelineActivity;->wearOpeningOnPhoneDialog:Lcom/google/glass/widget/MessageDialog;

    .line 778
    iget-object v2, p0, Lcom/google/glass/timeline/ui/TimelineActivity;->wearOpeningOnPhoneDialog:Lcom/google/glass/widget/MessageDialog;
    ...
    .line 783
    .local v1, "openOnPhoneSuccessBundle":Landroid/os/Bundle;
    const-string v2, "com.google.android.clockwork.actions.RpcWithCallback.successful"

    invoke-virtual {v1, v2, v5}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V

    .line 784
    iget-object v2, p0, Lcom/google/glass/timeline/ui/TimelineActivity;->handler:Landroid/os/Handler;
...
.method private updateWearOpeningOnPhoneDialog(Z)V
    .locals 4
    .param p1, "isIntentLaunchSuccessful"    # Z
...
.method protected canReadMore()Z
    ...
    invoke-virtual {v1}, Lcom/google/glass/timeline/ui/TimelineView;->getSelectedView()Landroid/view/View;
...
.method protected getTimelineItemDeletedListener(Lcom/google/googlex/glass/common/proto/TimelineNano$TimelineItem;)Lcom/google/glass/timeline/TimelineItemDeletedListener;
    ...
    invoke-virtual {v1}, Lcom/google/glass/timeline/ui/TimelineView;->getAdapter()Lcom/google/android/glass/widget/CardScrollAdapter;

    move-result-object v1

    invoke-virtual {v1, p1}, Lcom/google/android/glass/widget/CardScrollAdapter;->getPosition(Ljava/lang/Object;)I

    move-result v0

    .line 643
    .local v0, "position":I
    new-instance v1, Lcom/google/glass/timeline/DeleteAndAnimateTimelineItemListener;
    ...
    invoke-direct {v1, v2, v0, v3}, Lcom/google/glass/timeline/DeleteAndAnimateTimelineItemListener;-><init>(Lcom/google/android/glass/widget/CardScrollView;ILcom/google/glass/timeline/TimelineItemDeletedListener;)V
...
.method public onCreatePanelMenu(ILandroid/view/Menu;)Z
    ...
    invoke-virtual {v2}, Lcom/google/glass/timeline/ui/TimelineView;->getSelectedView()Landroid/view/View;
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {v5}, Lcom/google/glass/timeline/ui/TimelineView;->getSelectedView()Landroid/view/View;
    ...
    .line 605
    .local v1, "selectedCard":Lcom/google/glass/widget/horizontalscroll/Card;
    if-eqz v2, :cond_1

    .line 606
    invoke-interface {v1, p1}, Lcom/google/glass/widget/horizontalscroll/Card;->onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {v5}, Lcom/google/glass/timeline/ui/TimelineView;->getParentOfSelectedItem()Ljava/lang/Object;
    ...
    .line 618
    .local v3, "timelineItem":Lcom/google/googlex/glass/common/proto/TimelineNano$TimelineItem;
    if-eqz v3, :cond_0

    .line 621
    invoke-virtual {v3}, Lcom/google/googlex/glass/common/proto/TimelineNano$TimelineItem;->hasAttributionType()Z
    ...
    .line 622
    invoke-virtual {v3}, Lcom/google/googlex/glass/common/proto/TimelineNano$TimelineItem;->getAttributionType()I
    ...
    const-string v4, "com.google.android.wearable.app.WEAR_ITEM_OPEN_ACTION"
    ...
    .line 628
    iget-object v4, p0, Lcom/google/glass/timeline/ui/TimelineActivity;->screenOnResponseReceiver:Lcom/google/glass/timeline/ui/TimelineActivity$AndroidScreenOnResponseReceiver;

    iget-object v5, p0, Lcom/google/glass/timeline/ui/TimelineActivity;->broadcastReceiverRegistrar:Lcom/google/glass/context/BroadcastReceiverRegistrar;

    invoke-virtual {v4, v5}, Lcom/google/glass/timeline/ui/TimelineActivity$AndroidScreenOnResponseReceiver;->unregister(Lcom/google/glass/context/BroadcastReceiverRegistrar;)V
    ...
    .line 632
    :cond_2
    iget-object v4, p0, Lcom/google/glass/timeline/ui/TimelineActivity;->timelineMenuSelectionHandler:Lcom/google/glass/timeline/TimelineMenuSelectionHandler;

    .line 633
    invoke-virtual {p0, v3}, Lcom/google/glass/timeline/ui/TimelineActivity;->getTimelineItemDeletedListener(Lcom/google/googlex/glass/common/proto/TimelineNano$TimelineItem;)Lcom/google/glass/timeline/TimelineItemDeletedListener;
    ...
    .line 632
    invoke-virtual {v4, v3, p1, v5, v6}, Lcom/google/glass/timeline/TimelineMenuSelectionHandler;->handleOptionsItemSelected(Lcom/google/googlex/glass/common/proto/TimelineNano$TimelineItem;Landroid/view/MenuItem;Lcom/google/glass/timeline/TimelineItemDeletedListener;Ljava/lang/String;)Z
...
.method public onPrepareOptionsMenu(Landroid/view/Menu;)Z
    ...
    invoke-virtual {v1}, Lcom/google/glass/timeline/ui/TimelineView;->getSelectedItem()Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lcom/google/googlex/glass/common/proto/TimelineNano$TimelineItem;

    invoke-virtual {v2, v1}, Lcom/google/glass/timeline/TimelineItemLoggingHelper;->startMenuView(Lcom/google/googlex/glass/common/proto/TimelineNano$TimelineItem;)V
...
.method protected onResumeInternal()V
    ...
    .line 206
    invoke-virtual {p0, v4}, Lcom/google/glass/timeline/ui/TimelineActivity;->setNotificationItemId(Ljava/lang/String;)V

    .line 220
    :goto_0
    iget-object v3, p0, Lcom/google/glass/timeline/ui/TimelineActivity;->uiPerformanceLog:Lcom/google/glass/userevent/UiPerformanceLog;

    if-nez v3, :cond_0

    .line 221
    new-instance v3, Lcom/google/glass/userevent/UiPerformanceLog;
    ...
    invoke-direct {v3, v5, v6}, Lcom/google/glass/userevent/UiPerformanceLog;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object v3, p0, Lcom/google/glass/timeline/ui/TimelineActivity;->uiPerformanceLog:Lcom/google/glass/userevent/UiPerformanceLog;
    ...
    iget-object v5, p0, Lcom/google/glass/timeline/ui/TimelineActivity;->uiPerformanceLog:Lcom/google/glass/userevent/UiPerformanceLog;

    invoke-virtual {v3, v5}, Lcom/google/glass/timeline/ui/TimelineView;->setUiPerformanceLog(Lcom/google/glass/userevent/UiPerformanceLog;)V

    .line 226
    :cond_0
    iget-object v3, p0, Lcom/google/glass/timeline/ui/TimelineActivity;->uiPerformanceLog:Lcom/google/glass/userevent/UiPerformanceLog;

    invoke-virtual {v3}, Lcom/google/glass/userevent/UiPerformanceLog;->startPerformanceLogging()V

    .line 229
    iget-object v3, p0, Lcom/google/glass/timeline/ui/TimelineActivity;->syncStatusReceiver:Lcom/google/glass/sync/TimelineSyncStatusReceiver;

    invoke-virtual {v3, p0}, Lcom/google/glass/sync/TimelineSyncStatusReceiver;->register(Landroid/content/Context;)V

    .line 230
    iget-object v3, p0, Lcom/google/glass/timeline/ui/TimelineActivity;->timestampUpdateReceiver:Lcom/google/glass/timeline/ui/TimestampUpdateReceiver;

    invoke-virtual {v3, p0}, Lcom/google/glass/timeline/ui/TimestampUpdateReceiver;->register(Landroid/content/Context;)V

    .line 231
    iget-object v3, p0, Lcom/google/glass/timeline/ui/TimelineActivity;->timelineLogger:Lcom/google/glass/timeline/TimelineItemLoggingHelper;

    const/4 v5, -0x1

    invoke-virtual {v3, v4, v5}, Lcom/google/glass/timeline/TimelineItemLoggingHelper;->startLinger(Lcom/google/googlex/glass/common/proto/TimelineNano$TimelineItem;I)V

    .line 235
    sget-object v3, Lcom/google/glass/util/Labs$Feature;->LWOP:Lcom/google/glass/util/Labs$Feature;
    ...
    .line 236
    iget-object v3, p0, Lcom/google/glass/timeline/ui/TimelineActivity;->screenOnResponseReceiver:Lcom/google/glass/timeline/ui/TimelineActivity$AndroidScreenOnResponseReceiver;

    iget-object v4, p0, Lcom/google/glass/timeline/ui/TimelineActivity;->broadcastReceiverRegistrar:Lcom/google/glass/context/BroadcastReceiverRegistrar;

    invoke-virtual {v3, v4}, Lcom/google/glass/timeline/ui/TimelineActivity$AndroidScreenOnResponseReceiver;->register(Lcom/google/glass/context/BroadcastReceiverRegistrar;)Landroid/content/Intent;

    .line 239
    :cond_1
    iget-object v3, p0, Lcom/google/glass/timeline/ui/TimelineActivity;->wearHostCallbackSuccessReceiver:Lcom/google/glass/timeline/ui/TimelineActivity$WearHostCallbackSuccessReceiver;

    iget-object v4, p0, Lcom/google/glass/timeline/ui/TimelineActivity;->broadcastReceiverRegistrar:Lcom/google/glass/context/BroadcastReceiverRegistrar;

    invoke-virtual {v3, v4}, Lcom/google/glass/timeline/ui/TimelineActivity$WearHostCallbackSuccessReceiver;->register(Lcom/google/glass/context/BroadcastReceiverRegistrar;)Landroid/content/Intent;
    ...
    invoke-virtual {p0, v3}, Lcom/google/glass/timeline/ui/TimelineActivity;->getNotificationItemId(Landroid/content/Intent;)Lcom/google/glass/timeline/TimelineItemId;

    move-result-object v2

    .line 212
    .local v2, "itemId":Lcom/google/glass/timeline/TimelineItemId;
    if-eqz v2, :cond_3
    ...
    :goto_1
    invoke-virtual {p0, v3}, Lcom/google/glass/timeline/ui/TimelineActivity;->setNotificationItemId(Ljava/lang/String;)V
    ...
    .line 214
    .end local v2    # "itemId":Lcom/google/glass/timeline/TimelineItemId;
    :cond_4
    invoke-virtual {p0, v4}, Lcom/google/glass/timeline/ui/TimelineActivity;->setNotificationItemId(Ljava/lang/String;)V
