...
.method private isPreviouslyKnownCommandName(Ljava/lang/String;)Z
    ...
    .line 162
    :try_start_0
    iget-object v0, p0, Lcom/google/glass/voice/menu/GlassMenuUsageContract;->usageStatsDataCache:Ljava/util/List;
...
.method private updateUsageCountAndLastUsedTime(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v3, v6, v1, v2}, Landroid/content/ContentResolver;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    const-string v1, "Command name %s not found in usage_stats db."
...
.method private updateUsageStatsCache(Lcom/google/glass/voice/menu/GlassMenuUsageContract$UsageStatsData;)V
    ...
    .line 180
    iget-wide v2, p1, Lcom/google/glass/voice/menu/GlassMenuUsageContract$UsageStatsData;->lastUsedTimeMillis:J

    iput-wide v2, v0, Lcom/google/glass/voice/menu/GlassMenuUsageContract$UsageStatsData;->lastUsedTimeMillis:J

    .line 181
    iget-wide v2, p1, Lcom/google/glass/voice/menu/GlassMenuUsageContract$UsageStatsData;->usageCount:J

    iput-wide v2, v0, Lcom/google/glass/voice/menu/GlassMenuUsageContract$UsageStatsData;->usageCount:J
...
.method getMainMenuItemsData()Ljava/util/List;
    ...
    .line 266
    invoke-direct {p0, v1}, Lcom/google/glass/voice/menu/GlassMenuUsageContract;->fromCursorToUsageStatsData(Landroid/database/Cursor;)Lcom/google/glass/voice/menu/GlassMenuUsageContract$UsageStatsData;
...
.method public getSortedMainMenuItemsList(Ljava/util/List;)Ljava/util/List;
    ...
    const-string v2, "The usage stats cache is empty. This should never happen."
    ...
    .line 308
    :cond_0
    iget-object v0, p0, Lcom/google/glass/voice/menu/GlassMenuUsageContract;->sorter:Lcom/google/glass/voice/menu/GlassMenuSorter;

    iget-object v2, p0, Lcom/google/glass/voice/menu/GlassMenuUsageContract;->usageStatsDataCache:Ljava/util/List;

    iget-object v3, p0, Lcom/google/glass/voice/menu/GlassMenuUsageContract;->clock:Lcom/google/glass/time/Clock;

    .line 309
    invoke-virtual {v0, v2, v3}, Lcom/google/glass/voice/menu/GlassMenuSorter;->sortMainMenuItems(Ljava/util/List;Lcom/google/glass/time/Clock;)Ljava/util/List;

    move-result-object v0

    .line 310
    new-instance v2, Lcom/google/glass/voice/menu/GlassMenuUsageContract$VoiceMenuItemComparator;

    const/4 v3, 0x0

    invoke-direct {v2, v0, v3}, Lcom/google/glass/voice/menu/GlassMenuUsageContract$VoiceMenuItemComparator;-><init>(Ljava/util/List;Lcom/google/glass/voice/menu/GlassMenuUsageContract$1;)V
...
.method public insertOnlyIfPreviouslyUnknown(Ljava/lang/String;J)Z
    ...
    const-string v2, "commandName is empty"
    ...
    const-string v3, "Adding %s to the usageStatsDataCache."
    ...
    iget-object v6, v0, Lcom/google/glass/voice/menu/GlassMenuUsageContract$UsageStatsData;->commandName:Ljava/lang/String;
    ...
    new-instance v2, Lcom/google/glass/voice/menu/GlassMenuUsageContract$3;

    invoke-direct {v2, p0, v0}, Lcom/google/glass/voice/menu/GlassMenuUsageContract$3;-><init>(Lcom/google/glass/voice/menu/GlassMenuUsageContract;Lcom/google/glass/voice/menu/GlassMenuUsageContract$UsageStatsData;)V
