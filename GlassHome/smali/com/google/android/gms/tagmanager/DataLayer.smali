...
.field static final RB:[Ljava/lang/String;

.field private static final RC:Ljava/util/regex/Pattern;


# instance fields
.field private final RD:Ljava/util/concurrent/ConcurrentHashMap;
...
.field private final RE:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map",
            "<",
...
.field private final RF:Ljava/util/concurrent/locks/ReentrantLock;

.field private final RG:Ljava/util/LinkedList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private final RH:Lcom/google/android/gms/tagmanager/DataLayer$c;

.field private final RI:Ljava/util/concurrent/CountDownLatch;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/tagmanager/DataLayer;->RB:[Ljava/lang/String;
    ...
    sput-object v0, Lcom/google/android/gms/tagmanager/DataLayer;->RC:Ljava/util/regex/Pattern;
...
.method constructor <init>(Lcom/google/android/gms/tagmanager/DataLayer$c;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/tagmanager/DataLayer;->RH:Lcom/google/android/gms/tagmanager/DataLayer$c;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/tagmanager/DataLayer;->RD:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/tagmanager/DataLayer;->RE:Ljava/util/Map;

    new-instance v0, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {v0}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/tagmanager/DataLayer;->RF:Ljava/util/concurrent/locks/ReentrantLock;

    new-instance v0, Ljava/util/LinkedList;

    invoke-direct {v0}, Ljava/util/LinkedList;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/tagmanager/DataLayer;->RG:Ljava/util/LinkedList;
    ...
    iput-object v0, p0, Lcom/google/android/gms/tagmanager/DataLayer;->RI:Ljava/util/concurrent/CountDownLatch;

    invoke-direct {p0}, Lcom/google/android/gms/tagmanager/DataLayer;->gN()V
...
.method static synthetic a(Lcom/google/android/gms/tagmanager/DataLayer;)Ljava/util/concurrent/CountDownLatch;
    ...
    iget-object v0, p0, Lcom/google/android/gms/tagmanager/DataLayer;->RI:Ljava/util/concurrent/CountDownLatch;
...
.method static bc(Ljava/lang/String;)Ljava/lang/Long;
    .locals 10
    ...
    sget-object v1, Lcom/google/android/gms/tagmanager/DataLayer;->RC:Ljava/util/regex/Pattern;
    ...
    invoke-static {v1}, Lcom/google/android/gms/tagmanager/bf;->i(Ljava/lang/String;)V
...
.method private gN()V
    ...
    iget-object v0, p0, Lcom/google/android/gms/tagmanager/DataLayer;->RH:Lcom/google/android/gms/tagmanager/DataLayer$c;
...
.method private gO()V
    ...
    :goto_0
    iget-object v0, p0, Lcom/google/android/gms/tagmanager/DataLayer;->RG:Ljava/util/LinkedList;
    ...
    invoke-direct {p0, v0}, Lcom/google/android/gms/tagmanager/DataLayer;->q(Ljava/util/Map;)V
...
.method private l(Ljava/util/Map;)V
    ...
    iget-object v0, p0, Lcom/google/android/gms/tagmanager/DataLayer;->RF:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    invoke-direct {p0}, Lcom/google/android/gms/tagmanager/DataLayer;->gO()V

    :cond_0
    invoke-direct {p0, p1}, Lcom/google/android/gms/tagmanager/DataLayer;->m(Ljava/util/Map;)V
    :try_end_0
    ...
    iget-object v1, p0, Lcom/google/android/gms/tagmanager/DataLayer;->RF:Ljava/util/concurrent/locks/ReentrantLock;
...
.method private m(Ljava/util/Map;)V
    ...
    invoke-direct {p0, p1}, Lcom/google/android/gms/tagmanager/DataLayer;->n(Ljava/util/Map;)Ljava/lang/Long;
    ...
    :cond_0
    invoke-direct {p0, p1}, Lcom/google/android/gms/tagmanager/DataLayer;->p(Ljava/util/Map;)Ljava/util/List;
    ...
    iget-object v2, p0, Lcom/google/android/gms/tagmanager/DataLayer;->RH:Lcom/google/android/gms/tagmanager/DataLayer$c;
...
.method private n(Ljava/util/Map;)Ljava/lang/Long;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1}, Lcom/google/android/gms/tagmanager/DataLayer;->o(Ljava/util/Map;)Ljava/lang/Object;
    ...
    invoke-static {v0}, Lcom/google/android/gms/tagmanager/DataLayer;->bc(Ljava/lang/String;)Ljava/lang/Long;
...
.method private o(Ljava/util/Map;)Ljava/lang/Object;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    sget-object v2, Lcom/google/android/gms/tagmanager/DataLayer;->RB:[Ljava/lang/String;
...
.method private q(Ljava/util/Map;)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/tagmanager/DataLayer;->RE:Ljava/util/Map;
    ...
    invoke-virtual {p0, v0, v3}, Lcom/google/android/gms/tagmanager/DataLayer;->d(Ljava/lang/String;Ljava/lang/Object;)Ljava/util/Map;

    move-result-object v0

    iget-object v3, p0, Lcom/google/android/gms/tagmanager/DataLayer;->RE:Ljava/util/Map;
    ...
    invoke-direct {p0, p1}, Lcom/google/android/gms/tagmanager/DataLayer;->r(Ljava/util/Map;)V
...
.method private r(Ljava/util/Map;)V
    ...
    iget-object v0, p0, Lcom/google/android/gms/tagmanager/DataLayer;->RD:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-interface {v0, p1}, Lcom/google/android/gms/tagmanager/DataLayer$b;->j(Ljava/util/Map;)V
...
.method bb(Ljava/lang/String;)V
    ...
    invoke-interface {v0, p1}, Lcom/google/android/gms/tagmanager/DataLayer$c;->bd(Ljava/lang/String;)V

    return-void
.end method

.method d(Ljava/lang/String;Ljava/lang/Object;)Ljava/util/Map;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public get(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iget-object v4, p0, Lcom/google/android/gms/tagmanager/DataLayer;->RE:Ljava/util/Map;

    monitor-enter v4

    :try_start_0
    iget-object v2, p0, Lcom/google/android/gms/tagmanager/DataLayer;->RE:Ljava/util/Map;
...
.method public push(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    .prologue
    invoke-virtual {p0, p1, p2}, Lcom/google/android/gms/tagmanager/DataLayer;->d(Ljava/lang/String;Ljava/lang/Object;)Ljava/util/Map;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/google/android/gms/tagmanager/DataLayer;->RE:Ljava/util/Map;
