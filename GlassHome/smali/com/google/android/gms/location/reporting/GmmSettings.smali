...
.method public constructor <init>(IJLandroid/accounts/Account;Z)V
    ...
    .param p2, "readMillis"    # J
    .param p4, "account"    # Landroid/accounts/Account;
    .param p5, "reportingSelected"    # Z
    ...
    iput-wide p2, p0, Lcom/google/android/gms/location/reporting/GmmSettings;->IL:J

    iput-object p4, p0, Lcom/google/android/gms/location/reporting/GmmSettings;->IM:Landroid/accounts/Account;

    iput-boolean p5, p0, Lcom/google/android/gms/location/reporting/GmmSettings;->IN:Z

    return-void
.end method

.method public constructor <init>(JLandroid/accounts/Account;Z)V
    .locals 6
    .param p1, "valueReadMillis"    # J
    .param p3, "account"    # Landroid/accounts/Account;
    .param p4, "reportingSelected"    # Z
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .end local p1    # "o":Ljava/lang/Object;
    iget-wide v1, p0, Lcom/google/android/gms/location/reporting/GmmSettings;->IL:J

    iget-wide v3, p1, Lcom/google/android/gms/location/reporting/GmmSettings;->IL:J

    cmp-long v1, v1, v3

    if-nez v1, :cond_2

    iget-boolean v1, p0, Lcom/google/android/gms/location/reporting/GmmSettings;->IN:Z

    iget-boolean v2, p1, Lcom/google/android/gms/location/reporting/GmmSettings;->IN:Z
    ...
    iget-object v1, p0, Lcom/google/android/gms/location/reporting/GmmSettings;->IM:Landroid/accounts/Account;

    if-nez v1, :cond_2

    iget-object v1, p1, Lcom/google/android/gms/location/reporting/GmmSettings;->IM:Landroid/accounts/Account;
    ...
    :cond_2
    iget-object v0, p0, Lcom/google/android/gms/location/reporting/GmmSettings;->IM:Landroid/accounts/Account;
...
.method public getReadMillis()J
    ...
    iget-wide v0, p0, Lcom/google/android/gms/location/reporting/GmmSettings;->IL:J
...
.method public hashCode()I
    ...
    iget-wide v2, p0, Lcom/google/android/gms/location/reporting/GmmSettings;->IL:J

    iget-wide v4, p0, Lcom/google/android/gms/location/reporting/GmmSettings;->IL:J
    ...
    iget-boolean v2, p0, Lcom/google/android/gms/location/reporting/GmmSettings;->IN:Z
...
.method public isReportingSelected()Z
    ...
    iget-boolean v0, p0, Lcom/google/android/gms/location/reporting/GmmSettings;->IN:Z
