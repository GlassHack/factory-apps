...
.method private downloadResourceAndUpdateValidationTime()V
    ...
    invoke-virtual {v2, v3, v4}, Lcom/google/glass/deferredcontent/GlasswareResourceLoadingTask$CacheEntry;->setNextValidationTime(J)V
...
.method private loadFromDiskCache()Z
    ...
    .line 340
    iget-object v3, p0, Lcom/google/glass/deferredcontent/GlasswareResourceLoadingTask;->cachedFilesManager:Lcom/google/glass/util/CachedFilesManager;

    sget-object v4, Lcom/google/glass/util/FileType;->GLASSWARE_ICON:Lcom/google/glass/util/FileType;
    ...
    invoke-virtual {v3, v4, v5, v6}, Lcom/google/glass/util/CachedFilesManager;->load(Lcom/google/glass/util/FileType;Ljava/lang/String;Lcom/google/glass/util/CachedFilesManager$Loader;)Ljava/lang/Object;
    ...
    invoke-virtual {v2, v1, v3, v4}, Lcom/google/glass/deferredcontent/GlasswareResourceLoadingTask$CacheEntry;->populate([BJ)V
...
.method protected dispatchRequest(Lcom/google/googlex/glass/common/proto/ResourceNano$ResourceRequest;)Lcom/google/glass/net/ProtoResponse;
    .locals 3
    .param p1, "request"    # Lcom/google/googlex/glass/common/proto/ResourceNano$ResourceRequest;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lcom/google/googlex/glass/common/proto/ResourceNano$ResourceRequest;",
            ")",
...
.method downloadResource()J
    ...
    .line 272
    sget-object v5, Lcom/google/glass/deferredcontent/GlasswareResourceLoadingTask;->logger:Lcom/google/glass/logging/FormattingLogger;

    const-string v6, "Requesting resource: %s:%s, fingerprint=%s"

    new-array v7, v13, [Ljava/lang/Object;

    iget-object v8, p0, Lcom/google/glass/deferredcontent/GlasswareResourceLoadingTask;->projectId:Ljava/lang/String;

    aput-object v8, v7, v10

    iget v8, p0, Lcom/google/glass/deferredcontent/GlasswareResourceLoadingTask;->resourceType:I
    ...
    iget-object v8, p0, Lcom/google/glass/deferredcontent/GlasswareResourceLoadingTask;->entry:Lcom/google/glass/deferredcontent/GlasswareResourceLoadingTask$CacheEntry;

    invoke-virtual {v8}, Lcom/google/glass/deferredcontent/GlasswareResourceLoadingTask$CacheEntry;->getFingerprint()J
    ...
    iget v5, p0, Lcom/google/glass/deferredcontent/GlasswareResourceLoadingTask;->resourceType:I
    ...
    .line 277
    iget-object v5, p0, Lcom/google/glass/deferredcontent/GlasswareResourceLoadingTask;->projectId:Ljava/lang/String;
    ...
    invoke-virtual {v5}, Lcom/google/glass/deferredcontent/GlasswareResourceLoadingTask$CacheEntry;->getFingerprint()J

    move-result-wide v5

    invoke-virtual {v3, v5, v6}, Lcom/google/googlex/glass/common/proto/ResourceNano$ResourceRequest;->setFingerprint(J)Lcom/google/googlex/glass/common/proto/ResourceNano$ResourceRequest;
    ...
    :try_start_0
    invoke-virtual {p0, v3}, Lcom/google/glass/deferredcontent/GlasswareResourceLoadingTask;->dispatchRequest(Lcom/google/googlex/glass/common/proto/ResourceNano$ResourceRequest;)Lcom/google/glass/net/ProtoResponse;
    ...
    const-string v6, "New resource: %s:%s, fingerprint=%s"
    ...
    invoke-direct {p0, v5, v6, v7}, Lcom/google/glass/deferredcontent/GlasswareResourceLoadingTask;->saveToDiskCache(J[B)V

    .line 299
    :goto_0
    sget-wide v5, Lcom/google/glass/deferredcontent/GlasswareResourceLoadingTask;->CACHE_VALIDATION_INTERVAL_MS:J
    ...
    const-string v6, "Request interrupted: %s:%s"
    ...
    .line 288
    sget-wide v5, Lcom/google/glass/deferredcontent/GlasswareResourceLoadingTask;->CACHE_INTERRUPTED_RETRY_DELAY_MS:J

    goto :goto_1

    .line 297
    .end local v1    # "e":Ljava/lang/InterruptedException;
    .restart local v2    # "r":Lcom/google/glass/net/ProtoResponse;, "Lcom/google/glass/net/ProtoResponse<Lcom/google/googlex/glass/common/proto/ResourceNano$ResourceResponse;>;"
    :cond_1
    sget-object v5, Lcom/google/glass/deferredcontent/GlasswareResourceLoadingTask;->logger:Lcom/google/glass/logging/FormattingLogger;

    const-string v6, "No update: %s:%s"
    ...
    const-string v6, "Resource not found: %s:%s"
    ...
    const-string v6, "Request failed: %s:%s"
    ...
    .line 307
    sget-wide v5, Lcom/google/glass/deferredcontent/GlasswareResourceLoadingTask;->CACHE_RETRY_DELAY_MS:J
