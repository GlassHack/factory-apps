...
.method protected constructor <init>(Lcom/google/glass/userevent/UserEventAction$TimelineItemInserted;ILcom/google/glass/timeline/TimelineItemDatabaseHelper;)V
    .locals 4
    .param p1, "itemType"    # Lcom/google/glass/userevent/UserEventAction$TimelineItemInserted;
    .param p2, "userActionType"    # I
    .param p3, "databaseHelper"    # Lcom/google/glass/timeline/TimelineItemDatabaseHelper;
...
.method static synthetic access$000(Lcom/google/glass/timeline/TimelineItemCreatorJob;)I
    .locals 1
    .param p0, "x0"    # Lcom/google/glass/timeline/TimelineItemCreatorJob;
...
.method private dispatchCreateFinalItem()V
    ...
    iget-object v1, p0, Lcom/google/glass/timeline/TimelineItemCreatorJob;->databaseHelper:Lcom/google/glass/timeline/TimelineItemDatabaseHelper;

    invoke-virtual {v1, v0}, Lcom/google/glass/timeline/TimelineItemDatabaseHelper;->atomicUpdateTimelineItem(Lcom/google/glass/timeline/TimelineItemDatabaseHelper$Update;)V
    ...
    .end local v0    # "update":Lcom/google/glass/timeline/TimelineItemDatabaseHelper$Update;
    :cond_1
    move v1, v2
...
.method private dispatchCreateTemporaryItem()V
    ...
    .line 205
    iget-object v2, p0, Lcom/google/glass/timeline/TimelineItemCreatorJob;->logger:Lcom/google/glass/logging/FormattingLogger;
    ...
    .line 223
    .local v1, "update":Lcom/google/glass/timeline/TimelineItemDatabaseHelper$Update;
    ...
    invoke-virtual {v2, v1}, Lcom/google/glass/timeline/TimelineItemDatabaseHelper;->atomicUpdateTimelineItem(Lcom/google/glass/timeline/TimelineItemDatabaseHelper$Update;)V

    .line 224
    if-eqz v0, :cond_2

    .line 225
    invoke-virtual {v1}, Lcom/google/glass/timeline/TimelineItemDatabaseHelper$Update;->getItem()Lcom/google/googlex/glass/common/proto/TimelineNano$TimelineItem;
    ...
    .end local v1    # "update":Lcom/google/glass/timeline/TimelineItemDatabaseHelper$Update;
    :cond_1
    move v2, v4
    ...
    .restart local v1    # "update":Lcom/google/glass/timeline/TimelineItemDatabaseHelper$Update;
    :cond_2
    iget-object v2, p0, Lcom/google/glass/timeline/TimelineItemCreatorJob;->logger:Lcom/google/glass/logging/FormattingLogger;
...
.method public run()V
    ...
    iput-object v2, p0, Lcom/google/glass/timeline/TimelineItemCreatorJob;->runningOnThread:Ljava/lang/Thread;
    ...
    const-string v3, "Processing cancellation request"
    ...
    const-string v3, "Interrupted during deletion of temporary item."
