...
.field private static final FIELD_EXTENDED_PROPERTY:Ljava/lang/String; = "gd:extendedProperty"

.field private static final FIELD_REMINDER:Ljava/lang/String; = "gd:reminder"

.field private static final FIELD_WHEN:Ljava/lang/String; = "gd:when"

.field private static final FIELD_WHERE:Ljava/lang/String; = "gd:where"
...
.method public constructor <init>(Lcom/google/wireless/gdata2/parser/xml/XmlParserFactory;Lcom/google/wireless/gdata2/calendar/data/EventEntry;)V
    ...
    .param p2, "entry"    # Lcom/google/wireless/gdata2/calendar/data/EventEntry;
...
.method public constructor <init>(Lcom/google/wireless/gdata2/parser/xml/XmlParserFactory;Lcom/google/wireless/gdata2/calendar/data/EventEntry;Lcom/google/wireless/gdata2/calendar/data/EventEntry;)V
    .locals 15
    .param p1, "xmlFactory"    # Lcom/google/wireless/gdata2/parser/xml/XmlParserFactory;
    .param p2, "entry"    # Lcom/google/wireless/gdata2/calendar/data/EventEntry;
    .param p3, "oldEntry"    # Lcom/google/wireless/gdata2/calendar/data/EventEntry;
    ...
    .end local p3    # "oldEntry":Lcom/google/wireless/gdata2/calendar/data/EventEntry;
    :cond_0
    ...
    .line 78
    .restart local p3    # "oldEntry":Lcom/google/wireless/gdata2/calendar/data/EventEntry;
...
.method private static serializeReminder(Lorg/xmlpull/v1/XmlSerializer;Lcom/google/wireless/gdata2/calendar/data/Reminder;)V
    .locals 6
    .param p0, "serializer"    # Lorg/xmlpull/v1/XmlSerializer;
    .param p1, "reminder"    # Lcom/google/wireless/gdata2/calendar/data/Reminder;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method private serializeWhen(Lorg/xmlpull/v1/XmlSerializer;Lcom/google/wireless/gdata2/calendar/data/When;)V
    .locals 7
    .param p1, "serializer"    # Lorg/xmlpull/v1/XmlSerializer;
    .param p2, "when"    # Lcom/google/wireless/gdata2/calendar/data/When;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method private serializeWhere(Lorg/xmlpull/v1/XmlSerializer;)V
    ...
    const-string/jumbo v2, "valueString"
...
.method private static serializeWho(Lorg/xmlpull/v1/XmlSerializer;Lcom/google/wireless/gdata2/calendar/data/Who;)V
    .locals 8
    .param p0, "serializer"    # Lorg/xmlpull/v1/XmlSerializer;
    .param p1, "who"    # Lcom/google/wireless/gdata2/calendar/data/Who;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
            Lcom/google/wireless/gdata2/parser/ParseException;
