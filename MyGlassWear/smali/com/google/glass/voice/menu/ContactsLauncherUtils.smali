...
.method public static call(Lcom/google/glass/app/GlassActivity;Lcom/google/googlex/glass/common/proto/TimelineNano$Entity;)V
    .locals 1
    .param p0, "context"    # Lcom/google/glass/app/GlassActivity;
...
.method private static createSendMessageIntent(Lcom/google/googlex/glass/common/proto/TimelineNano$Entity;Z)Landroid/content/Intent;
    ...
    .line 192
    .local v2, "toId":Ljava/lang/String;
    const/4 v0, 0x3

    .line 193
    .local v0, "messageType":I
    sget-object v4, Lcom/google/glass/voice/menu/ContactsLauncherUtils;->logger:Lcom/google/glass/logging/FormattingLogger;

    const-string v8, "Initiating glassware message to entity [entityGuid=%s]."

    new-array v9, v6, [Ljava/lang/Object;

    aput-object v2, v9, v5

    invoke-interface {v4, v8, v9}, Lcom/google/glass/logging/FormattingLogger;->d(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 202
    invoke-static {v4, v0, v2, v5}, Lcom/google/glass/voice/VoiceMessageHelper;->createSendMessageIntent(IILjava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    move-result-object v3

    .line 206
    .local v3, "voiceMessageIntent":Landroid/content/Intent;
    const-string v4, "ENTITY_FOR_PROFILE_PHOTO"
    ...
    .line 215
    sget-object v4, Lcom/google/glass/voice/menu/ContactsLauncherUtils;->TAG:Ljava/lang/String;
    ...
    invoke-static {v7, v4, v5}, Lcom/google/glass/logging/Log;->logPii(ILjava/lang/String;Ljava/lang/String;)V

    .line 216
    return-object v3

    .end local v0    # "messageType":I
    .end local v1    # "smsDisabled":Z
    .end local v2    # "toId":Ljava/lang/String;
    .end local v3    # "voiceMessageIntent":Landroid/content/Intent;
    :cond_2
    move v1, v5
    ...
    .line 194
    .restart local v1    # "smsDisabled":Z
    :cond_3
    if-nez v1, :cond_4
    ...
    .line 196
    .restart local v2    # "toId":Ljava/lang/String;
    const/4 v0, 0x2
    ...
    .restart local v3    # "voiceMessageIntent":Landroid/content/Intent;
    :cond_6
    move v6, v7
...
.method private static createVoiceMessageController(Landroid/content/Context;Lcom/google/googlex/glass/common/proto/TimelineNano$Entity;)Lcom/google/glass/voice/VoiceMessageController;
    ...
    const-string v1, "Initiating glassware message to entity [entityGuid=%s]."
    ...
    sget-object v1, Lcom/google/glass/voice/menu/ContactsLauncherUtils;->TAG:Ljava/lang/String;
    ...
    .line 236
    .restart local v11    # "smsDisabled":Z
    :cond_3
    if-nez v11, :cond_4
    ...
    .restart local v7    # "messageType":I
    goto :goto_1
...
.method private static newCallEntityItem(Landroid/content/Context;Lcom/google/googlex/glass/common/proto/TimelineNano$Entity;Z)Lcom/google/glass/voice/menu/VoiceMenuItem;
    ...
    new-instance v2, Lcom/google/glass/voice/menu/ContactsLauncherUtils$3;

    invoke-direct {v2, p2, p0, p1}, Lcom/google/glass/voice/menu/ContactsLauncherUtils$3;-><init>(ZLandroid/content/Context;Lcom/google/googlex/glass/common/proto/TimelineNano$Entity;)V
...
.method public static newContactMenuItem(Landroid/content/Context;ZLcom/google/googlex/glass/common/proto/TimelineNano$Entity;I)Lcom/google/glass/voice/menu/VoiceMenuItem;
    ...
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "spoken"    # Z
    .param p2, "contactEntity"    # Lcom/google/googlex/glass/common/proto/TimelineNano$Entity;
...
.method private static shouldDisambiguatePhoneNumbers(Lcom/google/googlex/glass/common/proto/TimelineNano$Entity;)Z
    ...
    .line 144
    .restart local v0    # "mp":Lcom/google/googlex/glass/common/proto/TimelineNano$MessagingPersona;
    :cond_0
...
.method public static videoCall(Landroid/content/Context;Lcom/google/googlex/glass/common/proto/TimelineNano$Entity;)V
    ...
    invoke-virtual {v1, p0}, Lcom/google/glass/videocall/VideoCallHelperProvider;->get(Landroid/content/Context;)Lcom/google/glass/videocall/VideoCallHelper;

    move-result-object v0

    .line 172
    .local v0, "videoCallHelper":Lcom/google/glass/videocall/VideoCallHelper;
    const/4 v1, 0x1
