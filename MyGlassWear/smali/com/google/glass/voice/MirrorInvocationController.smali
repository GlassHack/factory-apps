...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/google/glass/voice/MirrorInvocationController$InvocationTimelineCreatorJob;
    }
.end annotation
...
.method static synthetic access$000(Lcom/google/glass/voice/MirrorInvocationController;)V
    .locals 0
    .param p0, "x0"    # Lcom/google/glass/voice/MirrorInvocationController;
...
.method public static getInputType(ILcom/google/googlex/glass/common/proto/TimelineNano$Entity;)I
    ...
    .line 238
    iget-object v2, p1, Lcom/google/googlex/glass/common/proto/TimelineNano$Entity;->acceptCommand:[Lcom/google/googlex/glass/common/proto/TimelineNano$Entity$Command;
    ...
    .line 239
    .local v0, "acceptCommand":Lcom/google/googlex/glass/common/proto/TimelineNano$Entity$Command;
    ...
    .line 240
    invoke-virtual {v0}, Lcom/google/googlex/glass/common/proto/TimelineNano$Entity$Command;->hasInputType()Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-virtual {v0}, Lcom/google/googlex/glass/common/proto/TimelineNano$Entity$Command;->getInputType()I

    move-result v1

    .line 245
    .end local v0    # "acceptCommand":Lcom/google/googlex/glass/common/proto/TimelineNano$Entity$Command;
    :goto_1
    return v1

    .line 241
    .restart local v0    # "acceptCommand":Lcom/google/googlex/glass/common/proto/TimelineNano$Entity$Command;
    :cond_0
    ...
    invoke-virtual {v1}, Lcom/google/glass/voice/menu/TriggerCommandUi;->getDefaultInputType()I
...
.method public static getInvocationIntent(IZLcom/google/googlex/glass/common/proto/TimelineNano$Entity;)Landroid/content/Intent;
    ...
    .line 262
    .local v0, "inputRequired":Z
    new-instance v1, Landroid/content/Intent;

    if-eqz v0, :cond_1

    const-string v2, "com.google.glass.ACTION_WITH_INPUT"

    :goto_0
    invoke-direct {v1, v2}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    .line 264
    .local v1, "invocationIntent":Landroid/content/Intent;
    ...
    .line 262
    .end local v1    # "invocationIntent":Landroid/content/Intent;
    :cond_1
    const-string v2, "com.google.glass.ACTION_NO_INPUT"

    goto :goto_0

    .line 264
    .restart local v1    # "invocationIntent":Landroid/content/Intent;
    :cond_2
    const/4 v2, 0x2
...
.method public static isInputExpected(ILcom/google/googlex/glass/common/proto/TimelineNano$Entity;)Z
    ...
    .line 250
    .local v0, "inputType":Ljava/lang/Integer;
    if-nez v0, :cond_1
...
.method public confirmInvocation()V
    ...
    .line 155
    .local v7, "ui":Lcom/google/glass/voice/menu/TriggerCommandUi;
    iget-boolean v0, p0, Lcom/google/glass/voice/MirrorInvocationController;->isInputExpected:Z
    ...
    invoke-virtual {v7}, Lcom/google/glass/voice/menu/TriggerCommandUi;->getConfirmationMessageId()I
    ...
    invoke-direct {v6, v1, v0}, Lcom/google/glass/widget/MessageDialog$Builder;-><init>(Landroid/content/Context;Lcom/google/glass/sound/SoundManager;)V

    .line 173
    .local v6, "dialog":Lcom/google/glass/widget/MessageDialog$Builder;
    invoke-virtual {p0}, Lcom/google/glass/voice/MirrorInvocationController;->getCommandType()I

    move-result v0

    invoke-static {v6, v0}, Lcom/google/glass/voice/menu/TriggerCommandUi;->bind(Lcom/google/glass/widget/MessageDialog$Builder;I)V
    ...
    invoke-virtual {v6, v0}, Lcom/google/glass/widget/MessageDialog$Builder;->setListener(Lcom/google/glass/widget/MessageDialog$Listener;)Lcom/google/glass/widget/MessageDialog$Builder;
...
.method public getInputModes()Ljava/util/List;
    ...
    invoke-static {v2}, Lcom/google/glass/voice/menu/TriggerCommandUi;->getUiByCommandType(I)Lcom/google/glass/voice/menu/TriggerCommandUi;

    move-result-object v2

    invoke-virtual {v2}, Lcom/google/glass/voice/menu/TriggerCommandUi;->getDisambiguationLabelId()I
    ...
    .line 126
    .local v0, "finalSelectedCommand":Ljava/lang/String;
    const/4 v1, 0x1
    ...
    new-instance v3, Lcom/google/glass/voice/MirrorInvocationController$2;

    invoke-direct {v3, p0}, Lcom/google/glass/voice/MirrorInvocationController$2;-><init>(Lcom/google/glass/voice/MirrorInvocationController;)V
