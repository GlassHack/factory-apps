...
.method private calculateTimeString(Lcom/google/googlex/glass/common/proto/TimelineNano$TimelineItem;)Ljava/lang/String;
    ...
    invoke-static {v0, v2, v3}, Lcom/google/glass/util/DateHelper;->getRelativeTimestamp(Landroid/content/Context;J)Ljava/lang/String;

    move-result-object v1

    .line 58
    .local v1, "relativeTime":Ljava/lang/String;
    ...
    .line 60
    invoke-virtual {v5}, Lcom/google/googlex/glass/common/proto/TimelineNano$Attachment;->hasCreationTime()Z
    ...
    .line 62
    invoke-virtual {v5}, Lcom/google/googlex/glass/common/proto/TimelineNano$Attachment;->getCreationTime()J

    move-result-wide v5

    .line 61
    invoke-static {v0, v5, v6}, Lcom/google/glass/util/DateHelper;->getRelativeTimestamp(Landroid/content/Context;J)Ljava/lang/String;

    move-result-object v4

    .line 65
    .local v4, "toRelativeTime":Ljava/lang/String;
    ...
    .line 66
    sget v5, Lcom/google/glass/common/R$string;->timeline_time_from_to:I
