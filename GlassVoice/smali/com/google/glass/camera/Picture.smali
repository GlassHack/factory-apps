...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/google/glass/camera/Picture$TriggerType;,
        Lcom/google/glass/camera/Picture$GcamType;
    }
.end annotation
...
.method private createFilePath()Ljava/lang/String;
    ...
    .line 361
    iget-object v1, p0, Lcom/google/glass/camera/Picture;->filePath:Ljava/lang/String;
    ...
    const-string v2, "Not generating file name because there is no file saver."
    ...
    iget-wide v3, p0, Lcom/google/glass/camera/Picture;->requestAbsoluteTimeMillis:J

    invoke-static {v3, v4}, Lcom/google/glass/util/FileHelper;->formatTimestamp(J)Ljava/lang/String;
...
.method public static getGcamType(Lcom/google/glass/camera/Picture;)Lcom/google/glass/camera/Picture$GcamType;
    .locals 1
    .param p0, "picture"    # Lcom/google/glass/camera/Picture;
...
.method saveThumbnail([BII)V
    ...
    const-string v2, "Encoded picture thumbnail in %s ms."
    ...
    iget-wide v6, p0, Lcom/google/glass/camera/Picture;->thumbnailTimeMillis:J
    ...
    invoke-static {p1, v1}, Lcom/google/glass/camera/CameraUtils;->populateFromYuv420Sp([BLandroid/graphics/Bitmap;)Z
    ...
    const-string v2, "populateFromYuv420Sp failed! Result may be corrupted."
...
.method protected setIsFinalPictureSaved(Z)V
    .locals 0
    .param p1, "isFinalPictureSaved"    # Z
    .annotation build Lcom/google/common/annotations/VisibleForTesting;
    .end annotation
...
.method setPrepareCameraSavings(J)V
    .locals 0
    .param p1, "prepareCameraSavingsMillis"    # J
...
.method setTriggerType(Lcom/google/glass/camera/Picture$TriggerType;)V
    .locals 0
    .param p1, "triggerType"    # Lcom/google/glass/camera/Picture$TriggerType;
