...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/google/glass/camera/CameraClient$TextureAvailabilityListener;,
        Lcom/google/glass/camera/CameraClient$PictureRequest;
    }
.end annotation
...
.method static synthetic access$100(Lcom/google/glass/camera/CameraClient;)Z
    .locals 1
    .param p0, "x0"    # Lcom/google/glass/camera/CameraClient;
...
.method static synthetic access$202(Lcom/google/glass/camera/CameraClient;Lcom/google/glass/camera/VideoWrapper;)Lcom/google/glass/camera/VideoWrapper;
    .locals 0
    .param p0, "x0"    # Lcom/google/glass/camera/CameraClient;
    .param p1, "x1"    # Lcom/google/glass/camera/VideoWrapper;
...
.method private calculatePostviewBufferSize(Z)I
    ...
    :goto_0
    sget-object v3, Lcom/google/glass/camera/CameraUtils;->POSTVIEW_SIZE:Lcom/google/glass/camera/Size;

    iget v3, v3, Lcom/google/glass/camera/Size;->width:I

    sget-object v4, Lcom/google/glass/camera/CameraUtils;->POSTVIEW_SIZE:Lcom/google/glass/camera/Size;
...
.method private calculatePreviewBufferSize()I
    ...
    .line 101
    .local v1, "bitsPerPixel":I
    sget-object v3, Lcom/google/glass/camera/CameraUtils;->PREVIEW_SIZE:Lcom/google/glass/camera/Size;

    iget v3, v3, Lcom/google/glass/camera/Size;->width:I

    sget-object v4, Lcom/google/glass/camera/CameraUtils;->PREVIEW_SIZE:Lcom/google/glass/camera/Size;
...
.method private getViewfinderSurfaceTexture()Landroid/graphics/SurfaceTexture;
    ...
    .line 622
    sget-object v4, Lcom/google/glass/camera/CameraClient;->testSurfaceTexture:Landroid/graphics/SurfaceTexture;
    ...
    .line 624
    sget-object v3, Lcom/google/glass/camera/CameraClient;->testSurfaceTexture:Landroid/graphics/SurfaceTexture;
    ...
    .line 628
    .local v2, "viewfinderLatch":Ljava/util/concurrent/CountDownLatch;
    iget-object v4, p0, Lcom/google/glass/camera/CameraClient;->viewfinder:Landroid/view/TextureView;

    new-instance v5, Lcom/google/glass/camera/CameraClient$TextureAvailabilityListener;

    invoke-direct {v5, p0, v2}, Lcom/google/glass/camera/CameraClient$TextureAvailabilityListener;-><init>(Lcom/google/glass/camera/CameraClient;Ljava/util/concurrent/CountDownLatch;)V
    ...
    const-string v5, "Stop waiting for viewfinder since release has been requested."
    ...
    const-string v5, "Viewfinder is not available after 10 seconds."
    ...
    const-string v4, "Interrupted waiting for viewfinder surface"
    ...
    .line 645
    iget-object v3, p0, Lcom/google/glass/camera/CameraClient;->viewfinder:Landroid/view/TextureView;
...
.method private openCamera()Z
    ...
    .line 700
    iget-object v3, p0, Lcom/google/glass/camera/CameraClient;->camera:Lcom/google/glass/android/hardware/Camera;
    ...
    const-string v3, "Camera is already opened!"
    ...
    invoke-virtual {v3}, Lcom/google/glass/android/hardware/CameraProvider;->open()Lcom/google/glass/android/hardware/Camera;

    move-result-object v3

    iput-object v3, p0, Lcom/google/glass/camera/CameraClient;->camera:Lcom/google/glass/android/hardware/Camera;
    ...
    iget-object v4, p0, Lcom/google/glass/camera/CameraClient;->errorCallback:Landroid/hardware/Camera$ErrorCallback;

    invoke-interface {v3, v4}, Lcom/google/glass/android/hardware/Camera;->setErrorCallback(Landroid/hardware/Camera$ErrorCallback;)V

    .line 709
    iget-object v3, p0, Lcom/google/glass/camera/CameraClient;->logger:Lcom/google/glass/logging/FormattingLogger;

    const-string v4, "Camera opened successfully!"
    ...
    .line 720
    iput-object v6, p0, Lcom/google/glass/camera/CameraClient;->camera:Lcom/google/glass/android/hardware/Camera;
...
.method protected dispatchError(Ljava/lang/String;)V
    ...
    const-string v2, "Dispatching error. [message=%s]"
    ...
    .line 955
    .local v0, "errorData":Ljava/lang/String;
    ...
    new-instance v2, Lcom/google/glass/camera/CameraClient$12;

    invoke-direct {v2, p0, p1}, Lcom/google/glass/camera/CameraClient$12;-><init>(Lcom/google/glass/camera/CameraClient;Ljava/lang/String;)V
...
.method public setCameraListener(Lcom/google/glass/camera/CameraListener;)V
    .locals 0
    .param p1, "listener"    # Lcom/google/glass/camera/CameraListener;
...
.method protected takePictureInternal(JIZ)V
    ...
    .line 452
    new-instance v6, Lcom/google/glass/camera/CameraClient$PictureRequest;

    iget-object v0, p0, Lcom/google/glass/camera/CameraClient;->fileSaver:Lcom/google/glass/util/FileSaver;

    iget v1, p0, Lcom/google/glass/camera/CameraClient;->pictureId:I

    invoke-direct {v6, p0, v0, v1}, Lcom/google/glass/camera/CameraClient$PictureRequest;-><init>(Lcom/google/glass/camera/CameraClient;Lcom/google/glass/util/FileSaver;I)V

    .line 453
    .local v6, "pictureRequest":Lcom/google/glass/camera/CameraClient$PictureRequest;
    iget v0, p0, Lcom/google/glass/camera/CameraClient;->pictureId:I
    ...
    .line 454
    iget-object v0, p0, Lcom/google/glass/camera/CameraClient;->pictureRequestList:Ljava/util/List;
    ...
    iget-object v1, v6, Lcom/google/glass/camera/CameraClient$PictureRequest;->captureCallback:Lcom/google/android/glass/media/CameraManager$CaptureCallback;

    invoke-virtual {v0, v1}, Lcom/google/android/glass/media/CameraManager;->setCaptureCallback(Lcom/google/android/glass/media/CameraManager$CaptureCallback;)Lcom/google/android/glass/media/CameraManager;

    .line 456
    iget-object v0, p0, Lcom/google/glass/camera/CameraClient;->cameraManager:Lcom/google/android/glass/media/CameraManager;

    iget-object v1, v6, Lcom/google/glass/camera/CameraClient$PictureRequest;->fallbackCaptureCallback:Lcom/google/android/glass/media/CameraManager$CaptureCallback;

    invoke-virtual {v0, v1}, Lcom/google/android/glass/media/CameraManager;->setFallbackCaptureCallback(Lcom/google/android/glass/media/CameraManager$CaptureCallback;)Lcom/google/android/glass/media/CameraManager;

    .line 457
    iget-object v0, p0, Lcom/google/glass/camera/CameraClient;->cameraManager:Lcom/google/android/glass/media/CameraManager;

    iget-object v1, v6, Lcom/google/glass/camera/CameraClient$PictureRequest;->shutterCallback:Landroid/hardware/Camera$ShutterCallback;

    invoke-virtual {v0, v1}, Lcom/google/android/glass/media/CameraManager;->setShutterCallback(Landroid/hardware/Camera$ShutterCallback;)Lcom/google/android/glass/media/CameraManager;

    .line 458
    iget-object v0, p0, Lcom/google/glass/camera/CameraClient;->cameraManager:Lcom/google/android/glass/media/CameraManager;

    iget-object v1, v6, Lcom/google/glass/camera/CameraClient$PictureRequest;->postviewCallback:Landroid/hardware/Camera$PictureCallback;

    invoke-virtual {v0, v1}, Lcom/google/android/glass/media/CameraManager;->setPostviewCallback(Landroid/hardware/Camera$PictureCallback;)Lcom/google/android/glass/media/CameraManager;

    .line 459
    iget-object v0, p0, Lcom/google/glass/camera/CameraClient;->cameraManager:Lcom/google/android/glass/media/CameraManager;

    iget-object v1, v6, Lcom/google/glass/camera/CameraClient$PictureRequest;->jpegCallback:Landroid/hardware/Camera$PictureCallback;

    invoke-virtual {v0, v1}, Lcom/google/android/glass/media/CameraManager;->setJpegCallback(Landroid/hardware/Camera$PictureCallback;)Lcom/google/android/glass/media/CameraManager;

    .line 461
    iget-object v0, v6, Lcom/google/glass/camera/CameraClient$PictureRequest;->picture:Lcom/google/glass/camera/Picture;

    invoke-virtual {v0, p1, p2}, Lcom/google/glass/camera/Picture;->setRequestTime(J)V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/google/glass/camera/Picture;->setPrepareCameraSavings(J)V
    ...
    .line 478
    iget-object v7, p0, Lcom/google/glass/camera/CameraClient;->cameraManager:Lcom/google/android/glass/media/CameraManager;
    ...
    invoke-virtual {v7, v0}, Lcom/google/android/glass/media/CameraManager;->open(Lcom/google/android/glass/media/CameraManager$OpenCallback;)V
...
.method protected updateVideoRecorderOptions(Landroid/media/MediaRecorder;)V
    .locals 0
    .param p1, "videoRecorder"    # Landroid/media/MediaRecorder;
