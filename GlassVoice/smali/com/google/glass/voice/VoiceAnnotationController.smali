...
.method static synthetic access$000(Lcom/google/glass/voice/VoiceAnnotationController;)V
    .locals 0
    .param p0, "x0"    # Lcom/google/glass/voice/VoiceAnnotationController;
...
.method private confirmAnnotation()V
    ...
    invoke-interface {v1}, Lcom/google/glass/voice/ActionController$Callback;->onActionCanceled()V
    ...
    .line 320
    iget-object v1, p0, Lcom/google/glass/voice/VoiceAnnotationController;->soundManager:Lcom/google/glass/sound/SoundManager;
...
.method private getSpeakNowPromptText()Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Lcom/google/glass/voice/VoiceAnnotationController;->shouldShowPrompt(Landroid/content/Intent;)Z
    ...
    invoke-virtual {p0, v1}, Lcom/google/glass/voice/VoiceAnnotationController;->getCustomPromptText(Landroid/content/Intent;)Ljava/lang/String;
...
.method private launchPendingIntent(Ljava/lang/String;)V
    ...
    :cond_0
    invoke-direct {p0, v2, p1}, Lcom/google/glass/voice/VoiceAnnotationController;->attachResult(Landroid/os/Bundle;Ljava/lang/String;)V
    ...
    :try_start_0
    iget-object v4, p0, Lcom/google/glass/voice/VoiceAnnotationController;->context:Landroid/content/Context;
    ...
    invoke-interface {v4, v2}, Lcom/google/glass/voice/ActionController$Callback;->onActionCompleted(Landroid/os/Bundle;)V
    ...
    iget-object v4, p0, Lcom/google/glass/voice/VoiceAnnotationController;->logger:Lcom/google/glass/logging/FormattingLogger;
...
.method private launchVoiceTrigger(Ljava/lang/String;)V
    ...
    .prologue
    .line 419
    iget-object v2, p0, Lcom/google/glass/voice/VoiceAnnotationController;->intent:Landroid/content/Intent;
    ...
    invoke-interface {v2, v0}, Lcom/google/glass/voice/ActionController$Callback;->onActionCompleted(Landroid/os/Bundle;)V
...
.method onAnnotationCommitted(Ljava/lang/String;)V
    ...
    iget-boolean v2, p0, Lcom/google/glass/voice/VoiceAnnotationController;->recordAudio:Z

    if-eqz v2, :cond_2

    iget-object v2, p0, Lcom/google/glass/voice/VoiceAnnotationController;->audioOutputStream:Ljava/io/ByteArrayOutputStream;
...
.method onFinalResult(Lcom/google/glass/voice/OpenEndedInputController;Ljava/lang/String;)V
    ...
    .line 263
    iput-object p2, p0, Lcom/google/glass/voice/VoiceAnnotationController;->recognitionResult:Ljava/lang/String;
...
.method public showAddingDialog(Ljava/lang/String;)V
    ...
    iget-object v3, p0, Lcom/google/glass/voice/VoiceAnnotationController;->soundManager:Lcom/google/glass/sound/SoundManager;
    ...
    sget v2, Lcom/google/glass/common/R$string;->voice_annotation_adding:I
    ...
    sget v2, Lcom/google/glass/common/R$drawable;->ic_message_50:I
    ...
    sget v2, Lcom/google/glass/common/R$string;->voice_annotation_added:I
    ...
    new-instance v2, Lcom/google/glass/voice/VoiceAnnotationController$3;

    invoke-direct {v2, p0, p1}, Lcom/google/glass/voice/VoiceAnnotationController$3;-><init>(Lcom/google/glass/voice/VoiceAnnotationController;Ljava/lang/String;)V
    ...
    .line 380
    .local v0, "dialogBuilder":Lcom/google/glass/widget/MessageDialog$Builder;
    ...
    invoke-direct {p0, v1}, Lcom/google/glass/voice/VoiceAnnotationController;->showMessage(Lcom/google/glass/widget/MessageDialog;)V
...
.method wantAudioData(Landroid/content/Intent;)Z
    ...
    .prologue
    .line 190
    const-string/jumbo v0, "want_audio_data"
