...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/google/glass/babel/AudioMessageHelper$Provider;
    }
.end annotation
...
.method private saveClip([BLjava/lang/String;)Ljava/lang/String;
    ...
    const-string v3, "Unable to save null or empty audio clip."
    ...
    .line 261
    :cond_1
    new-instance v2, Lcom/google/glass/babel/WaveFileWrapper;

    invoke-direct {v2}, Lcom/google/glass/babel/WaveFileWrapper;-><init>()V

    invoke-virtual {v2, p1}, Lcom/google/glass/babel/WaveFileWrapper;->wrap([B)[B
    ...
    sget-object v2, Lcom/google/glass/util/FileType;->AUDIO:Lcom/google/glass/util/FileType;

    invoke-static {p1}, Lcom/google/glass/util/FileSaver;->newSaver([B)Lcom/google/glass/util/FileSaver$Saver;

    move-result-object v3

    invoke-virtual {v0, v2, p2, v3}, Lcom/google/glass/util/CachedFilesManager;->save(Lcom/google/glass/util/FileType;Ljava/lang/String;Lcom/google/glass/util/FileSaver$Saver;)Z
    ...
    invoke-virtual {v0, v1, p2}, Lcom/google/glass/util/CachedFilesManager;->getPath(Lcom/google/glass/util/FileType;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v3, "Failed to save audio clip."
...
.method private streamAudio(Ljava/lang/String;)Z
    ...
    const-string v5, "Streaming audio message."
    ...
    invoke-virtual {v4}, Lcom/google/glass/android/media/MediaPlayerProvider;->get()Landroid/media/MediaPlayer;
    ...
    .line 185
    new-instance v4, Lcom/google/glass/babel/AudioMessageHelper$2;

    invoke-direct {v4, p0}, Lcom/google/glass/babel/AudioMessageHelper$2;-><init>(Lcom/google/glass/babel/AudioMessageHelper;)V

    invoke-virtual {v1, v4}, Landroid/media/MediaPlayer;->setOnPreparedListener(Landroid/media/MediaPlayer$OnPreparedListener;)V

    .line 193
    new-instance v4, Lcom/google/glass/babel/AudioMessageHelper$3;

    invoke-direct {v4, p0}, Lcom/google/glass/babel/AudioMessageHelper$3;-><init>(Lcom/google/glass/babel/AudioMessageHelper;)V

    invoke-virtual {v1, v4}, Landroid/media/MediaPlayer;->setOnErrorListener(Landroid/media/MediaPlayer$OnErrorListener;)V

    .line 200
    new-instance v4, Lcom/google/glass/babel/AudioMessageHelper$4;

    invoke-direct {v4, p0}, Lcom/google/glass/babel/AudioMessageHelper$4;-><init>(Lcom/google/glass/babel/AudioMessageHelper;)V

    invoke-virtual {v1, v4}, Landroid/media/MediaPlayer;->setOnInfoListener(Landroid/media/MediaPlayer$OnInfoListener;)V

    .line 207
    new-instance v4, Lcom/google/glass/babel/AudioMessageHelper$5;

    invoke-direct {v4, p0}, Lcom/google/glass/babel/AudioMessageHelper$5;-><init>(Lcom/google/glass/babel/AudioMessageHelper;)V
    ...
    const-string v5, "Setting MediaPlayer data source [source=%s]."
    ...
    invoke-interface {v4, v0, v5, v2}, Lcom/google/glass/logging/FormattingLogger;->w(Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public attachAudioToTimelineItem([BLcom/google/googlex/glass/common/proto/TimelineNano$TimelineItem;Ljava/lang/String;)V
    ...
    .line 67
    .local v0, "audioAttachment":Lcom/google/googlex/glass/common/proto/TimelineNano$Attachment;
    if-nez v0, :cond_1

    .line 68
    sget-object v1, Lcom/google/glass/babel/AudioMessageHelper;->logger:Lcom/google/glass/logging/FormattingLogger;

    const-string v2, "Unable to save audio clip, skipping timeline item attachment."
...
.method public getStreamingUrl(Lcom/google/googlex/glass/common/proto/TimelineNano$TimelineItem;)Ljava/lang/String;
    ...
    .line 88
    .local v0, "playAudioMenuItem":Lcom/google/googlex/glass/common/proto/TimelineNano$MenuItem;
    if-eqz v0, :cond_0
...
.method public playAudio(Lcom/google/googlex/glass/common/proto/TimelineNano$Attachment;Ljava/lang/String;Ljava/lang/String;)Z
    .locals 7
    .param p1, "audioAttachment"    # Lcom/google/googlex/glass/common/proto/TimelineNano$Attachment;
    .param p2, "streamingUrl"    # Ljava/lang/String;
    ...
    invoke-virtual {v1, v4, v5}, Lcom/google/glass/util/CachedFilesManager;->load(Ljava/lang/String;Lcom/google/glass/util/CachedFilesManager$Loader;)Ljava/lang/Object;
    ...
    const-string v5, "Bad audio attachment with invalid client cache path."
    ...
    .restart local v1    # "cachedFilesManager":Lcom/google/glass/util/CachedFilesManager;
    :cond_1
    sget-object v4, Lcom/google/glass/babel/AudioMessageHelper;->logger:Lcom/google/glass/logging/FormattingLogger;

    const-string v5, "Playing back client cached audio message."
    ...
    const-string v5, "Malformed audio attachment or menu item [timelineItemId=%s]."
...
.method public playAudioForTimelineItem(Lcom/google/googlex/glass/common/proto/TimelineNano$TimelineItem;)Z
    ...
    .line 141
    sget-object v3, Lcom/google/glass/util/Labs$Feature;->HAM:Lcom/google/glass/util/Labs$Feature;
    ...
    .line 148
    .local v1, "streamingUrl":Ljava/lang/String;
    if-nez v0, :cond_1
    ...
    const-string v4, "Timeline item does not have an audio attachment or menu item to play."
    ...
    invoke-virtual {p0, v0, v1, v2}, Lcom/google/glass/babel/AudioMessageHelper;->playAudio(Lcom/google/googlex/glass/common/proto/TimelineNano$Attachment;Ljava/lang/String;Ljava/lang/String;)Z
...
.method public saveAudioAndCreateAttachment([BLjava/lang/String;)Lcom/google/googlex/glass/common/proto/TimelineNano$Attachment;
    ...
    iget-object v3, p0, Lcom/google/glass/babel/AudioMessageHelper;->context:Landroid/content/Context;
    ...
    invoke-direct {p0, p1, v2}, Lcom/google/glass/babel/AudioMessageHelper;->saveClip([BLjava/lang/String;)Ljava/lang/String;
    ...
    const-string v3, "Unable to save audio clip, skipping audio attachment."
    ...
    .line 241
    invoke-virtual {v2, v0}, Lcom/google/googlex/glass/common/proto/TimelineNano$Attachment;->setClientCachePath(Ljava/lang/String;)Lcom/google/googlex/glass/common/proto/TimelineNano$Attachment;
    ...
    .line 242
    invoke-virtual {v2, v3}, Lcom/google/googlex/glass/common/proto/TimelineNano$Attachment;->setContentType(Ljava/lang/String;)Lcom/google/googlex/glass/common/proto/TimelineNano$Attachment;
    ...
    invoke-virtual {v2, v3}, Lcom/google/googlex/glass/common/proto/TimelineNano$Attachment;->setSource(Ljava/lang/String;)Lcom/google/googlex/glass/common/proto/TimelineNano$Attachment;
