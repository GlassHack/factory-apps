...
.method private performUpload(Z)V
    ...
    const-string v22, "problem in DataUsageReporter: "
...
.method private static scheduleNextUpload(Landroid/content/Context;)V
    ...
    .line 226
    .local v5, "sched":Lcom/android/common/OperationScheduler;
    invoke-static {p0}, Lcom/google/android/gsf/usagestats/StatsUploadService;->isUploadEnabled(Landroid/content/Context;)Z
    ...
    .line 231
    .local v4, "options":Lcom/android/common/OperationScheduler$Options;
    invoke-virtual {p0}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v6

    const-string v9, "usagestats:upload_interval_millis"
    ...
    iput-wide v9, v4, Lcom/android/common/OperationScheduler$Options;->periodicIntervalMillis:J
    ...
    const-class v9, Lcom/google/android/gsf/usagestats/StatsUploadService;
    ...
    invoke-virtual {v5, v4}, Lcom/android/common/OperationScheduler;->getNextTimeMillis(Lcom/android/common/OperationScheduler$Options;)J
    ...
    .line 245
    sget-boolean v6, Lcom/google/android/gsf/usagestats/StatsUploadService;->LOCAL_LOGV:Z

    if-eqz v6, :cond_0

    const-string v6, "StatsUploadService"

    const-string v7, "Upload disabled"
    ...
    .end local v4    # "options":Lcom/android/common/OperationScheduler$Options;
    :cond_1
    move v6, v8
    ...
    .restart local v4    # "options":Lcom/android/common/OperationScheduler$Options;
    :cond_2
    sget-boolean v6, Lcom/google/android/gsf/usagestats/StatsUploadService;->LOCAL_LOGV:Z
    ...
    const-string v9, "Scheduling next upload for "
