...
.method constructor <init>(Ljava/lang/String;Ljava/lang/String;IIIIIIIIDIIIIIILjava/lang/String;Ljava/lang/String;Ljava/lang/String;ZZZZJILjava/util/Map;)V
    ...
    .param p3, "port"    # I
    .param p4, "rmqAckInterval"    # I
    .param p5, "minReconnectDelayShort"    # I
    .param p6, "reconnectVariantShort"    # I
    .param p7, "minReconnectDelayLong"    # I
    .param p8, "reconnectVariantLong"    # I
    .param p9, "maxReconnectDelay"    # I
    .param p10, "shortNetworkDowntime"    # I
    .param p11, "reconnectBackoffRateMultiplier"    # D
    .param p13, "activeHeartbeat"    # I
    .param p14, "idleHeartbeat"    # I
    .param p15, "syncHeartbeat"    # I
    .param p16, "defaultHeartbeat"    # I
    .param p17, "wifiHeartbeat"    # I
    .param p18, "heartbeatAckTimeout"    # I
    .param p19, "username"    # Ljava/lang/String;
    .param p20, "authToken"    # Ljava/lang/String;
    .param p21, "deviceId"    # Ljava/lang/String;
    .param p22, "useAndroidId"    # Z
    .param p23, "useRmq2"    # Z
    .param p24, "supportRmqAndRmq2"    # Z
    .param p25, "rmq2IncludeStreamId"    # Z
    .param p26, "clockSkewThresholdMs"    # J
    .param p28, "maxConnectionHistoryRecords"    # I
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/lang/String;",
...
.method public static createAccountFromSettings(Lcom/google/android/gsf/gtalkservice/service/GTalkService;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)Lcom/google/android/gsf/gtalkservice/Account;
    .locals 44
    .param p0, "service"    # Lcom/google/android/gsf/gtalkservice/service/GTalkService;
    .param p1, "username"    # Ljava/lang/String;
    .param p2, "authToken"    # Ljava/lang/String;
    .param p3, "deviceId"    # Ljava/lang/String;
    .param p4, "useAndroidId"    # Z
...
.method private static createGTalkAccount(Ljava/lang/String;IIIIIIIIDIIIIIILjava/lang/String;Ljava/lang/String;Ljava/lang/String;ZZZZJILjava/util/Map;)Lcom/google/android/gsf/gtalkservice/Account;
    ...
    .param p1, "port"    # I
    .param p2, "rmqAckInterval"    # I
    .param p3, "minReconnectDelayShort"    # I
    .param p4, "reconnectVariantShort"    # I
    .param p5, "minReconnectDelayLong"    # I
    .param p6, "reconnectVariantLong"    # I
    .param p7, "maxReconnectDelay"    # I
    .param p8, "shortNetworkDowntime"    # I
    .param p9, "reconnectBackoffRateMultiplier"    # D
    .param p11, "heartbeatActive"    # I
    .param p12, "heartbeatIdle"    # I
    .param p13, "heartbeatSync"    # I
    .param p14, "heartbeatLong"    # I
    .param p15, "heartbeatWifi"    # I
    .param p16, "heartbeatAck"    # I
    .param p17, "username"    # Ljava/lang/String;
    .param p18, "authToken"    # Ljava/lang/String;
    .param p19, "deviceId"    # Ljava/lang/String;
    .param p20, "useAndroidId"    # Z
    .param p21, "useRmq2"    # Z
    .param p22, "supportRmqAndRmq2"    # Z
    .param p23, "rmq2IncludeStreamId"    # Z
    .param p24, "clockSkewThreshold"    # J
    .param p26, "maxConnectionHistoryRecords"    # I
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/lang/String;",
...
.method private loginSettingsMatch(Lcom/google/android/gsf/gtalkservice/Account;)Z
    .locals 10
    .param p1, "other"    # Lcom/google/android/gsf/gtalkservice/Account;
