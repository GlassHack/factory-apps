...
.method public constructor <init>(Lcom/google/android/gsf/gtalkservice/gtalk/ChatMgr;Landroid/content/Context;Landroid/content/ContentResolver;Lcom/google/android/gsf/gtalkservice/gtalk/GTalkConnection;JLjava/lang/String;Ljava/lang/String;)V
    .locals 3
    .param p1, "chatMgr"    # Lcom/google/android/gsf/gtalkservice/gtalk/ChatMgr;
    .param p2, "context"    # Landroid/content/Context;
    .param p3, "resolver"    # Landroid/content/ContentResolver;
    .param p4, "connection"    # Lcom/google/android/gsf/gtalkservice/gtalk/GTalkConnection;
...
.method public constructor <init>(Lcom/google/android/gsf/gtalkservice/gtalk/ChatMgr;Landroid/content/Context;Landroid/content/ContentResolver;Lcom/google/android/gsf/gtalkservice/gtalk/GTalkConnection;JLjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .param p5, "accountId"    # J
    .param p7, "username"    # Ljava/lang/String;
    .param p8, "room"    # Ljava/lang/String;
    .param p9, "myGroupChatNickname"    # Ljava/lang/String;
...
.method static synthetic access$000(Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;
...
.method static synthetic access$1200(Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;Lcom/google/android/gtalkservice/IChatListener;)V
    .locals 0
    .param p0, "x0"    # Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;
    .param p1, "x1"    # Lcom/google/android/gtalkservice/IChatListener;
...
.method private addChatToDatabase(JLjava/lang/String;Ljava/lang/String;ZZJ)V
    ...
    .param p3, "jidResource"    # Ljava/lang/String;
    .param p4, "message"    # Ljava/lang/String;
    .param p5, "outgoing"    # Z
    .param p6, "groupChat"    # Z
    ...
    const-string v3, "addChatToDatabase: bad contactId "
...
.method private addChatToDatabase(Landroid/content/ContentValues;Ljava/lang/String;Ljava/lang/String;ZZZJ)V
    ...
    .param p2, "jidResource"    # Ljava/lang/String;
    .param p3, "message"    # Ljava/lang/String;
    .param p4, "outgoing"    # Z
    .param p5, "groupChat"    # Z
    .param p6, "forOtherClient"    # Z
    .param p7, "accountId"    # J
...
.method private addChatToDatabase(Ljava/lang/String;JLjava/lang/String;Ljava/lang/String;ZZ)V
    ...
    .param p4, "jidResource"    # Ljava/lang/String;
    .param p5, "message"    # Ljava/lang/String;
    .param p6, "outgoing"    # Z
    .param p7, "forOtherClient"    # Z
    ...
    const-string v3, "addChatToDatabase: insert new chat for "
    ...
    const-string v3, ", forOtherClient="
...
.method private addGroupMessageToDatabase(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;JJIJJ)Landroid/net/Uri;
    ...
    .param p9, "accountId"    # J
    .param p11, "consolidationKey"    # J
    ...
    const-string v4, "addGroupMessageToDb: invalid group id "
    ...
    invoke-static {v1, v3}, Lcom/google/android/gsf/gtalkservice/Log;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .end local p1    # "nickname":Ljava/lang/String;
    :cond_1
    invoke-virtual {v2, v1, p1}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 1760
    invoke-direct/range {v1 .. v7}, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->addTimeStamp(Landroid/content/ContentValues;JJI)V
    ...
    invoke-direct {p0, v0}, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->isOtrMessageType(I)Z
    ...
    invoke-static {v3, v4}, Lcom/google/android/gsf/TalkContract$Messages;->getOtrMessagesContentUriByThreadId(J)Landroid/net/Uri;
...
.method private declared-synchronized addMessageToDatabase(Lorg/jivesoftware/smack/packet/Message;Ljava/lang/String;ZZ)Landroid/net/Uri;
    .locals 40
    .param p1, "msg"    # Lorg/jivesoftware/smack/packet/Message;
    .param p2, "bareJid"    # Ljava/lang/String;
    .param p3, "outgoing"    # Z
    .param p4, "sending"    # Z
    ...
    iget-object v3, v0, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->mOutgoingConsolidation:Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$Consolidation;

    .line 1282
    .local v3, "consolidation":Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$Consolidation;
    :goto_3
    const/4 v6, 0x0
    ...
    invoke-direct/range {v2 .. v7}, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->checkMatch(Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$Consolidation;JLjava/lang/String;Z)Z
    ...
    iget-wide v6, v3, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$Consolidation;->mConsolidationKey:J
    ...
    .line 1304
    .local v30, "retVal":Landroid/net/Uri;
    if-nez v30, :cond_5
    ...
    .line 1264
    .end local v3    # "consolidation":Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$Consolidation;
    .end local v4    # "date":J
    .end local v10    # "messageType":I
    .end local v11    # "realDate":J
    .end local v30    # "retVal":Landroid/net/Uri;
    .end local v34    # "match":Z
    :cond_2
    const/4 v10, 0x1
    ...
    .line 1273
    .restart local v10    # "messageType":I
    .restart local v11    # "realDate":J
    :cond_3
    move-object/from16 v0, p0

    invoke-direct {v0, v11, v12}, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->modifyTimeStampIfNecessary(J)J
    ...
    iget-object v3, v0, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->mIncomingConsolidation:Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$Consolidation;

    goto/16 :goto_3

    .line 1309
    .restart local v3    # "consolidation":Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$Consolidation;
    .restart local v30    # "retVal":Landroid/net/Uri;
    .restart local v34    # "match":Z
    :cond_5
    const/16 v31, 0x0

    .line 1310
    .local v31, "previous":Landroid/net/Uri;
    if-eqz p3, :cond_6
    ...
    .line 1313
    .local v35, "otherConsolidation":Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$Consolidation;
    :goto_4
    monitor-enter p0
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .line 1317
    :try_start_2
    iget-wide v0, v3, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$Consolidation;->mConsolidationRowTimeStamp:J

    move-wide/from16 v38, v0

    .line 1318
    .local v38, "prevMeTime":J
    ...
    iget-object v2, v3, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$Consolidation;->mPreviousUri:Landroid/net/Uri;
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_1
    ...
    :goto_5
    :try_start_3
    iget-object v0, v3, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$Consolidation;->mPreviousUri:Landroid/net/Uri;
    ...
    iput-object v0, v3, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$Consolidation;->mPreviousUri:Landroid/net/Uri;

    .line 1345
    iput-wide v4, v3, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$Consolidation;->mConsolidationRowTimeStamp:J
    ...
    invoke-direct/range {v17 .. v33}, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->consolidate(Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$Consolidation;ZLjava/lang/String;Ljava/lang/String;Ljava/lang/String;ZJJJLandroid/net/Uri;Landroid/net/Uri;ZLjava/lang/String;)V
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_0
    ...
    .end local v30    # "retVal":Landroid/net/Uri;
    .end local v31    # "previous":Landroid/net/Uri;
    .end local v35    # "otherConsolidation":Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$Consolidation;
    .end local v36    # "otherTime":J
    .end local v38    # "prevMeTime":J
    :catchall_0
    move-exception v2
    ...
    .restart local v3    # "consolidation":Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$Consolidation;
    .restart local v4    # "date":J
    .restart local v8    # "packetId":Ljava/lang/String;
    .restart local v9    # "body":Ljava/lang/String;
    .restart local v10    # "messageType":I
    .restart local v11    # "realDate":J
    .restart local v15    # "accountId":J
    .restart local v30    # "retVal":Landroid/net/Uri;
    .restart local v31    # "previous":Landroid/net/Uri;
    .restart local v34    # "match":Z
    :cond_6
    :try_start_5
    move-object/from16 v0, p0
    ...
    .line 1321
    .restart local v35    # "otherConsolidation":Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$Consolidation;
    .restart local v36    # "otherTime":J
    .restart local v38    # "prevMeTime":J
    :cond_7
    const/16 v19, 0x0
...
.method private checkMatch(Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$Consolidation;JLjava/lang/String;Z)Z
    .locals 7
    .param p1, "consolidation"    # Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$Consolidation;
    .param p2, "timestamp"    # J
    .param p4, "groupChatNickName"    # Ljava/lang/String;
    .param p5, "sending"    # Z
...
.method private consolidate(Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$Consolidation;ZLjava/lang/String;Ljava/lang/String;Ljava/lang/String;ZJJJLandroid/net/Uri;Landroid/net/Uri;ZLjava/lang/String;)V
    ...
    .param p2, "match"    # Z
    .param p3, "nickname"    # Ljava/lang/String;
    .param p4, "bareJid"    # Ljava/lang/String;
    .param p5, "body"    # Ljava/lang/String;
    .param p6, "outgoing"    # Z
    .param p7, "realDate"    # J
    .param p9, "date"    # J
    .param p11, "accountId"    # J
    .param p13, "current"    # Landroid/net/Uri;
    .param p14, "previous"    # Landroid/net/Uri;
    .param p15, "sending"    # Z
    .param p16, "packetId"    # Ljava/lang/String;
    ...
    .line 1146
    .local v28, "u":Landroid/net/Uri;
    :goto_1
    if-nez v28, :cond_3

    .line 1240
    .end local v10    # "messageType":I
    .end local v21    # "consolidationType":I
    .end local v26    # "ts_start":J
    .end local v28    # "u":Landroid/net/Uri;
    :cond_0
    :goto_2
    return-void

    .line 1112
    .restart local v26    # "ts_start":J
    :cond_1
    const/4 v10, 0x1
    ...
    .line 1135
    .restart local v10    # "messageType":I
    .restart local v21    # "consolidationType":I
    :cond_2
    const/4 v8, 0x0
    ...
    .restart local v28    # "u":Landroid/net/Uri;
    goto :goto_1
    ...
    iput-object v0, v1, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$Consolidation;->mConsolidatedRowUri:Landroid/net/Uri;
    ...
    .line 1176
    .local v30, "updateCountShouldBeTwo":I
    const/4 v2, 0x2
    ...
    const-string v4, "expected 2 from update, got "
    ...
    .end local v24    # "id1":Ljava/lang/String;
    .end local v25    # "id2":Ljava/lang/String;
    .end local v28    # "u":Landroid/net/Uri;
    .end local v30    # "updateCountShouldBeTwo":I
    :cond_5
    :goto_3
    invoke-static {}, Landroid/os/SystemClock;->uptimeMillis()J
    ...
    const-string v3, "consolidate: url="
    ...
    iget-object v3, v0, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$Consolidation;->mConsolidatedRowUri:Landroid/net/Uri;
    ...
    .line 1178
    .end local v22    # "elapsed":J
    .restart local v20    # "baseUri":Landroid/net/Uri;
    .restart local v24    # "id1":Ljava/lang/String;
    .restart local v25    # "id2":Ljava/lang/String;
    .restart local v28    # "u":Landroid/net/Uri;
    .restart local v30    # "updateCountShouldBeTwo":I
    :cond_6
    const-string v2, "GTalkService"
    ...
    const-string v3, "handleConsolidation: update msgs id1="
    ...
    const-string v3, "handleConsolidation: match, update consolidation row for key "
    ...
    .line 1193
    .local v5, "values2":Landroid/content/ContentValues;
    const-string v2, "body"

    move-object/from16 v0, p1

    iget-object v3, v0, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$Consolidation;->mConsolidatedBody:Ljava/lang/String;
    ...
    .line 1217
    .local v29, "updateCountShouldBeOne":I
    const/4 v2, 0x1
    ...
    const-string v4, "expected 1 from update, got "
    ...
    .line 1228
    .end local v5    # "values2":Landroid/content/ContentValues;
    .end local v20    # "baseUri":Landroid/net/Uri;
    .end local v24    # "id1":Ljava/lang/String;
    .end local v29    # "updateCountShouldBeOne":I
    .restart local v22    # "elapsed":J
    :cond_b
...
.method private createGroupChatInDatabase(Ljava/lang/String;)V
    ...
    .prologue
    .line 1982
    invoke-direct/range {p0 .. p0}, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->getGroupChatDisplayName()Ljava/lang/String;
    ...
    const-string v2, "createGroupChatInDatabase for "
    ...
    iget-object v1, v0, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->mResolver:Landroid/content/ContentResolver;
    ...
    invoke-static/range {v1 .. v10}, Lcom/google/android/gsf/gtalkservice/gtalk/DatabaseHelper;->addContact(Landroid/content/ContentResolver;JJLjava/lang/String;Ljava/lang/String;III)Landroid/net/Uri;
    ...
    iput-wide v1, v0, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->mGroupContactId:J
    ...
    const-string v2, "createGroupChatInDb: added "
    ...
    const-string v2, " to contacts, id="
    ...
    iget-wide v2, v0, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->mGroupContactId:J
    ...
    iget-wide v9, v0, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->mGroupContactId:J
    ...
    invoke-direct/range {v8 .. v16}, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->addChatToDatabase(JLjava/lang/String;Ljava/lang/String;ZZJ)V
    ...
    const-string v3, "##### createGroupChatInDatabase: add "
    ...
    const-string v3, " to contacts table failed!"
...
.method private debugMessageTimeStamp(JJJ)V
    ...
    .line 1608
    .local v0, "messageDate":Landroid/text/format/Time;
    ...
    .line 1611
    .local v1, "nowDate":Landroid/text/format/Time;
...
.method private doAddMessageToDatabase(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;IJJJJZ)Landroid/net/Uri;
    ...
    invoke-virtual {v2, v9, v3}, Landroid/content/ContentResolver;->insert(Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
...
.method private messageTargetedForAnotherClient(Ljava/lang/String;)Z
    .locals 3
    .param p1, "toAddr"    # Ljava/lang/String;
    ...
    const-string v2, "messageTargetedForAnotherClient: true, toAddr="
...
.method private modifyTimeStampIfNecessary(J)J
    ...
    const-string v1, "modifyTimeStampIfNecessary: server clock skew is "
    ...
    .line 1589
    .local v5, "clockSkewThresholdMs":J
...
.method private notifyChat(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;JZ)V
    ...
    .prologue
    .line 2203
    iget-object v3, p0, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->mChatMgr:Lcom/google/android/gsf/gtalkservice/gtalk/ChatMgr;

    iget-object v3, v3, Lcom/google/android/gsf/gtalkservice/gtalk/ChatMgr;->mChatListenerCallback:Lcom/google/android/gsf/gtalkservice/gtalk/RemoteListenerCallback;

    iget-object v4, p0, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->mChatListeners:Ljava/util/ArrayList;

    new-instance v6, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$7;

    move-object/from16 v0, p4

    move/from16 v1, p7

    invoke-direct {v6, p0, p1, v0, v1}, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$7;-><init>(Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;Ljava/lang/String;Ljava/lang/String;Z)V

    invoke-virtual {v3, v4, v6}, Lcom/google/android/gsf/gtalkservice/gtalk/RemoteListenerCallback;->call(Ljava/util/ArrayList;Lcom/google/android/gsf/gtalkservice/gtalk/RemoteListenerCallback$Callable;)Z

    move-result v11

    .line 2221
    .local v11, "useLightweightNotify":Z
    ...
    const-string v4, "notifyChat for "
    ...
    const-string v4, ", useLightweightNotify="
    ...
    const-string v4, ", # chat session listeners="
    ...
    invoke-virtual {v3, p1, v0, v1}, Lcom/google/android/gsf/gtalkservice/gtalk/ChatMgr;->notifyChat(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-virtual {v3}, Lcom/google/android/gsf/gtalkservice/service/GTalkService;->getStatusBarNotifier()Lcom/google/android/gsf/gtalkservice/service/StatusBarNotifier;

    move-result-object v2

    .line 2231
    .local v2, "notifier":Lcom/google/android/gsf/gtalkservice/service/StatusBarNotifier;
    ...
    .line 2244
    .end local v2    # "notifier":Lcom/google/android/gsf/gtalkservice/service/StatusBarNotifier;
...
.method private notifyConvertedToGroupChat(Lcom/google/android/gtalkservice/IChatListener;Ljava/lang/String;Ljava/lang/String;J)V
    ...
    .param p2, "oldJid"    # Ljava/lang/String;
...
.method private postMissedCallNotification(Ljava/lang/String;Ljava/lang/String;ZZ)V
    ...
    new-instance v4, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$5;

    invoke-direct {v4, p0}, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$5;-><init>(Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;)V

    invoke-virtual {v1, v2, v4}, Lcom/google/android/gsf/gtalkservice/gtalk/RemoteListenerCallback;->call(Ljava/util/ArrayList;Lcom/google/android/gsf/gtalkservice/gtalk/RemoteListenerCallback$Callable;)Z

    move-result v9

    .line 1458
    .local v9, "useLightweightNotify":Z
    iget-object v1, p0, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->mGTalkConnection:Lcom/google/android/gsf/gtalkservice/gtalk/GTalkConnection;
    ...
    .end local v12    # "notifMessageRes":I
    :cond_1
    const v12, 0x7f09006a

    .restart local v12    # "notifMessageRes":I
    goto :goto_0
...
.method private saveUnsentComposedMessageInternal(Ljava/lang/String;)V
    ...
    .prologue
    .line 1799
    iget-object v7, p0, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->mTo:Ljava/lang/String;

    invoke-static {v7}, Lorg/jivesoftware/smack/util/StringUtils;->parseBareAddress(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    .line 1800
    .local v0, "bareJid":Ljava/lang/String;
    iget-object v7, p0, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->mChatMgr:Lcom/google/android/gsf/gtalkservice/gtalk/ChatMgr;

    invoke-virtual {v7, v0}, Lcom/google/android/gsf/gtalkservice/gtalk/ChatMgr;->getChatSession(Ljava/lang/String;)Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;
    ...
    .line 1807
    :cond_1
    const-string v4, "contact_id in (select _id from contacts where account=? AND username=?)"
    ...
    const-string v7, "unsent_composed_message"

    invoke-virtual {v6, v7, p1}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/String;)V

    .line 1813
    iget-object v7, p0, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->mResolver:Landroid/content/ContentResolver;

    sget-object v8, Lcom/google/android/gsf/TalkContract$Chats;->CONTENT_URI:Landroid/net/Uri;

    invoke-virtual {v7, v8, v6, v4, v5}, Landroid/content/ContentResolver;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-static {v7}, Lorg/jivesoftware/smack/util/StringUtils;->parseResource(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v7, v0, v8, v9}, Lcom/google/android/gsf/gtalkservice/gtalk/DatabaseHelper;->getIdForContact(Landroid/content/ContentResolver;Ljava/lang/String;J)J
    ...
    iget-boolean v8, p0, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->mGroupChat:Z
    ...
    .line 1828
    const-string v7, "last_message_date"
...
.method private updateChatInDatabase(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZZ)V
    ...
    .line 1970
    :goto_0
    iget-object v1, p0, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->mChatSelectionArgs:[Ljava/lang/String;
    ...
    .line 1966
    :cond_0
    invoke-direct {p0, v1}, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->setUnreadMessage(Ljava/lang/String;)V
...
.method public closeChat()V
    ...
    const-string v6, "closeChat: mTo="

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-object v6, p0, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->mTo:Ljava/lang/String;
    ...
    invoke-direct {p0, v5}, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->log(Ljava/lang/String;)V
    ...
    iget-boolean v5, p0, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->mGroupChat:Z
    ...
    invoke-static {v5, v4, v0, v1}, Lcom/google/android/gsf/gtalkservice/gtalk/DatabaseHelper;->getIdForContact(Landroid/content/ContentResolver;Ljava/lang/String;J)J
    ...
    invoke-static {v5, v2, v3}, Lcom/google/android/gsf/gtalkservice/gtalk/DatabaseHelper;->closeChatForContactId(Landroid/content/ContentResolver;J)V
    ...
    const-string v6, "closeChat: remove room \""
    ...
    const-string v6, "\" from contacts, account="
    ...
    invoke-static {v5, v0, v1, v4}, Lcom/google/android/gsf/gtalkservice/gtalk/DatabaseHelper;->deleteContact(Landroid/content/ContentResolver;JLjava/lang/String;)I
    ...
    .line 2143
    iget-object v5, p0, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->mChatMgr:Lcom/google/android/gsf/gtalkservice/gtalk/ChatMgr;

    invoke-virtual {v5, p0}, Lcom/google/android/gsf/gtalkservice/gtalk/ChatMgr;->removeChatSession(Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;)V
...
.method convertToGroupChat(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/Runnable;
    ...
    .line 2061
    iget-boolean v4, p0, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->mGroupChat:Z
    ...
    .line 2067
    .local v2, "oldBareJid":Ljava/lang/String;
    iget-wide v4, p0, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->mGroupContactId:J

    invoke-direct {p0, v2, p1, v4, v5}, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->notifyWillConvertToGroupChat(Ljava/lang/String;Ljava/lang/String;J)V
    ...
    invoke-static {v4, v2, v5, v6}, Lcom/google/android/gsf/gtalkservice/gtalk/DatabaseHelper;->getIdForContact(Landroid/content/ContentResolver;Ljava/lang/String;J)J
    ...
    invoke-static {v4, v0, v1}, Lcom/google/android/gsf/gtalkservice/gtalk/DatabaseHelper;->closeChatForContactId(Landroid/content/ContentResolver;J)V
    ...
    const-string v5, "convertToGroupChat: mTo="
    ...
    .line 2087
    iget-object v4, p0, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->mUsername:Ljava/lang/String;

    invoke-virtual {p0, v4}, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->setGroupChatNickname(Ljava/lang/String;)V
    ...
    iput-object v4, p0, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->mToBareJid:Ljava/lang/String;

    .line 2091
    const/4 v4, 0x1

    invoke-direct {p0, v4}, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->setIsGroupChat(Z)V

    .line 2093
    const/4 v4, 0x6

    invoke-direct {p0, v3, v3, v4}, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->addGroupMessageToDatabase(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    .line 2098
    new-instance v3, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$6;

    invoke-direct {v3, p0, v2, p1}, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$6;-><init>(Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;Ljava/lang/String;Ljava/lang/String;)V
...
.method public ensureNonZeroLastMessageDate()V
    ...
    .line 2510
    :try_start_0
    iget-wide v3, p0, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->mLastMessageTimestamp:J
    ...
    iget-wide v5, p0, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->mAccountId:J

    invoke-static {v3, v4, v5, v6}, Lcom/google/android/gsf/gtalkservice/gtalk/DatabaseHelper;->getIdForContact(Landroid/content/ContentResolver;Ljava/lang/String;J)J
...
.method public getLightweightNotify()Z
    ...
    new-instance v3, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$8;

    invoke-direct {v3, p0}, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$8;-><init>(Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;)V
...
.method public getUnsentComposedMessage()Ljava/lang/String;
    ...
    .line 1841
    .local v6, "bareJid":Ljava/lang/String;
    ...
    .line 1852
    .local v8, "unsentComposedMessage":Ljava/lang/String;
    if-eqz v7, :cond_1
...
.method handlePresenceChanged(Lorg/jivesoftware/smack/packet/Presence;)V
    ...
    const-string v2, "\" did not change"
...
.method public initialize(ZZ)V
    .locals 3
    .param p1, "initiatedLocally"    # Z
    .param p2, "asyncInit"    # Z
...
.method onReceiveGroupMessage(Lorg/jivesoftware/smack/packet/Message;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .param p1, "message"    # Lorg/jivesoftware/smack/packet/Message;
    .param p2, "room"    # Ljava/lang/String;
    .param p3, "fullNickname"    # Ljava/lang/String;
...
.method public reportEndCause(Ljava/lang/String;ZI)V
    ...
    new-instance v4, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$4;

    invoke-direct {v4, p0}, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession$4;-><init>(Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;)V
...
.method public reportMissedCall(Ljava/lang/String;Ljava/lang/String;ZZ)V
    ...
    invoke-direct {p0, v1, v2}, Lcom/google/android/gsf/gtalkservice/gtalk/ChatSession;->addMessageToDatabase(Ljava/lang/String;I)V
    ...
    .line 1421
    .end local v0    # "dbMessageRes":I
    :cond_0
    const v0, 0x7f09006e

    .restart local v0    # "dbMessageRes":I
    goto :goto_0
